...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Rs(e,t,n){let r=new Float32Array(ws),i=new q(0,1,0);return new eo({name:`SphericalGaussianBlur`,defines:{n:ws,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zs(){return new eo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(){return new eo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vs(),fragmentShader:`
	...
	`}var Hs=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new li(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}_getCompositeMaterial(e){return new eo({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};Ru.BlurDirectionX=new K(1,0),Ru.BlurDirectionY=new K(0,1);var zu=15248462,Bu=15786688,Vu=new WeakMap;function Hu(e,t){e&&Vu.get(e)?.(t)}var Uu=[`#dfd7c7`,`#d0c7b4`,`#bfb5a0`],Wu=13682612,Gu=[`#121826`,`#1e2130`,`#28303f`,`#2f3b4e`],Ku=1185830;function qu(e={}){let t=e.deep?Gu:Uu,n=document.createElement(`canvas`);n.width=2,n.height=256;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,256);e.deep?(i.addColorStop(0,t[0]),i.addColorStop(.45,t[1]),i.addColorStop(.75,t[2]),i.addColorStop(1,t[3])):(i.addColorStop(0,t[0]),i.addColorStop(.58,t[1]),i.addColorStop(1,t[2])),r.fillStyle=i,r.fillRect(0,0,2,256);let a=new ui(n);return a.colorSpace=Ie,a}function Ju(r,i={}){let a=n(),o=(()=>{try{return window.matchMedia(`(pointer: fine)`).matches}catch{return!a}})(),s=(()=>{try{return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}})(),c;try{c=new Eu({antialias:!a,alpha:i.alpha===!0,powerPreference:a?`default`:`high-performance`})}catch(e){return{error:e,dispose:()=>{}}}let l=i.deep===!0,u=new hn;u.fog=new mn(l?Ku:Wu,.02);let d=i.alpha===!0?null:qu({deep:l});d&&(u.background=d);let f=new Po(i.fov??(a?54:48),1,.1,80);if(f.position.set(0,0,12),c.setPixelRatio(Math.min(window.devicePixelRatio||1,a?1.3:o?1.5:1.25)),c.setClearColor(l?Ku:Wu,i.alpha===!0?0:1),c.outputColorSpace=Ie,c.domElement.style.cssText=`display:block;width:100%;height:100%;touch-action:none`,r.appendChild(c.domElement),i.lights!==!1){u.add(new Bo(12101770,.62));let e=new zo(16773336,1.1);e.position.set(3,5,6),u.add(e);let t=new Io(zu,1.2,30);t.position.set(-3,2,4),u.add(t)}let p=null,m=null;if(i.stars!==!1){let e=o?1200:700,t=new Float32Array(e*3);for(let n=0;n<e;n++)t[n*3]=(Math.random()-.5)*55,t[n*3+1]=(Math.random()-.5)*36,t[n*3+2]=-6-Math.random()*32;p=new cr,p.setAttribute(`position`,new Jn(t,3));let n=i.alpha===!0||l;m=new si(p,new ni({color:n?Bu:7168853,size:o?.04:.05,transparent:!0,opacity:n?.8:.42,depthWrite:!1,blending:n?2:1})),u.add(m)}let h=null;if(i.bloom!==!1&&o&&!s)try{h=new Fu(c),h.addPass(new Iu(u,f)),h.addPass(new Ru(new K(1,1),.32,.5,.8))}catch{h=null}let g=new on;u.add(g);let _=i.fitHalf??4.2,v=i.fitHalf??4.2,y=()=>{let t=r.clientWidth||1,n=r.clientHeight||1,o=t/Math.max(1,n),s=e(t,n);f.aspect=o,f.fov=i.fov??(a?56:s?46:50);let l=f.fov*Math.PI/180,u=Math.tan(l/2),d=i.hudReserveFrac==null?Math.max(92,Math.min(196,n*(a?.19:.13))):n*i.hudReserveFrac,p=Math.min(.45,d/Math.max(1,n)),m=a?1.05:s?1.06:1.08,y=v*m/(u*Math.max(.05,1-p)),b=_*m/(u*Math.max(.2,o)),x=Math.max(y,b),S=p*x*u;g.position.set(0,-S,0),f.position.set(0,0,x),f.lookAt(0,0,0),f.updateProjectionMatrix(),c.setSize(t,n,!1),h?.setSize(t,n)};y();let b=new ResizeObserver(y);b.observe(r);let x=()=>y();window.visualViewport?.addEventListener(`resize`,x);let S=0,C=performance.now(),w=null,T=!1,E=0,D=0,O=e=>{S=requestAnimationFrame(O);let t=e-D,n=T?0:Math.min(.05,(t-C)/1e3);T||(C=t),!s&&m&&!T&&(m.rotation.y+=n*.01);try{w?.(n,t)}catch(e){console.warn(`[c3d] tick`,e)}h?h.render():c.render(u,f)};S=requestAnimationFrame(O);let k=e=>{let t=!!e;t!==T&&(T=t,T?E=performance.now():(D+=performance.now()-E,C=performance.now()-D))};return Vu.set(r,k),{scene:u,camera:f,renderer:c,playRoot:g,coarse:a,fine:o,reduced:s,setFitHalf:e=>{_=e,v=e,y()},setFitBox:(e,t)=>{_=e,v=t??e,y()},frame:y,setTick:e=>{w=e},setPaused:k,dispose:()=>{cancelAnimationFrame(S),b.disconnect(),window.visualViewport?.removeEventListener(`resize`,x),p?.dispose(),m?.material.dispose(),h?.dispose(),c.dispose(),t(c),c.domElement.parentNode===r&&r.removeChild(c.domElement)},error:null}}function Yu(e,t={}){return new no({color:e,emissive:new X(t.emissive??e),emissiveIntensity:t.emissiveIntensity??0,metalness:t.metalness??.4,roughness:t.roughness??.4,transparent:t.transparent??!1,opacity:t.opacity??1})}function Xu(e){let t=new Set;e.traverse(e=>{e.geometry&&!t.has(e.geometry)&&(t.add(e.geometry),e.geometry.dispose()),e.material&&(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{e&&!t.has(e)&&(t.add(e),e.dispose?.())})})}export{Ie as C,Ga as D,Wa as E,K as O,Va as S,Ha as T,d as _,mi as a,Ba as b,X as c,Si as d,La as f,l as g,ti as h,Hu as i,q as k,_i as l,Ur as m,Xu as n,ui as o,on as p,Yu as r,hi as s,Ju as t,gi as u,jr as v,$i as w,os as x,yr as y};