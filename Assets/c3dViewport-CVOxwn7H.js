import{Bt as e,C as t,E as n,It as r,Lt as i,Pt as a,Rt as o,St as s,X as c,Z as l,h as u,st as d,u as f}from"./three.module-gLDqqtIh.js";var p={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};w.BlurDirectionX=new i(1,0),w.BlurDirectionY=new i(0,1);function T(){try{return window.matchMedia(`(pointer: coarse)`).matches||window.matchMedia(`(hover: none)`).matches}catch{return!1}}function E(e,t){return e>=900||e/Math.max(1,t)>=1.2&&e>=700}export{x as a,S as i,E as n,w as r,T as t};