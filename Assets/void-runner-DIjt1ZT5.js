...
`;function te(e,t,{onBack:n,isAppSfxOn:r,isAppMusicOn:a}){let o=typeof navigator<`u`&&(navigator.maxTouchPoints>0||`ontouchstart`in window),s=t=>e.querySelector(t),c=s(`#vr-canvas`),l=window.AudioContext||window.webkitAudioContext,u=null;function ee(){u||=new l,u.state===`suspended`&&u.resume()}let te=()=>r?.()!==!1,ne=()=>a?.()!==!1;function d(e,t,n,r,i=0){if(!u||!te())return;let a=u.createOscillator(),o=u.createGain();a.connect(o),o.connect(u.destination),a.type=t,a.frequency.setValueAtTime(e,u.currentTime+i),o.gain.setValueAtTime(r,u.currentTime+i),o.gain.exponentialRampToValueAtTime(.001,u.currentTime+i+n),a.start(u.currentTime+i),a.stop(u.currentTime+i+n+.05)}function re(){if(!u)return;let e=u.createOscillator(),t=u.createGain();e.connect(t),t.connect(u.destination),e.type=`sawtooth`,e.frequency.setValueAtTime(800,u.currentTime),e.frequency.exponentialRampToValueAtTime(200,u.currentTime+.15),t.gain.setValueAtTime(.12,u.currentTime),t.gain.exponentialRampToValueAtTime(.001,u.currentTime+.15),e.start(),e.stop(u.currentTime+.2)}function ie(){[523,659,784,1047].forEach((e,t)=>d(e,`sine`,.12,.08,t*.05))}function ae(){u&&[60,80,100,120].forEach(e=>{let t=u.createBuffer(1,u.sampleRate*.5,u.sampleRate),n=t.getChannelData(0);for(let e=0;e<n.length;e++)n[e]=(Math.random()*2-1)*(1-e/n.length);let r=u.createBufferSource(),i=u.createGain(),a=u.createBiquadFilter();r.buffer=t,a.type=`lowpass`,a.frequency.value=e*30,r.connect(a),a.connect(i),i.connect(u.destination),i.gain.setValueAtTime(.3,u.currentTime),i.gain.exponentialRampToValueAtTime(.001,u.currentTime+.6),r.start()})}function oe(){[400,500,600,800,1e3].forEach((e,t)=>d(e,`square`,.1,.06,t*.08))}function se(){d(120,`sawtooth`,.3,.15),d(80,`square`,.4,.1,.05)}function ce(){J&&u&&d(440,`sine`,.08,.06*Y)}function le(){J&&d(880,`square`,.05,.035*Y)}function ue(){J&&(d(220,`sawtooth`,.1,.07*Y),d(140,`square`,.12,.05*Y,.02))}function de(){J&&[660,880,1320].forEach((e,t)=>d(e,`triangle`,.12,.07*Y,t*.06))}let fe=!1,pe=null,f=null,me=[[220,261.63,329.63],[174.61,220,261.63],[130.81,164.81,196],[196,246.94,293.66]],he=[[440,523,659,523,440,392,440,523],[349,440,523,440,349,330,349,440],[262,330,392,330,262,247,262,330],[392,494,587,494,392,370,392,494]],ge=60/128,p=ge*4;function _e(e,t){let n=e.createOscillator(),r=e.createGain();n.connect(r),r.connect(f),n.frequency.setValueAtTime(180,t),n.frequency.exponentialRampToValueAtTime(40,t+.08),r.gain.setValueAtTime(.55,t),r.gain.exponentialRampToValueAtTime(.001,t+.18),n.start(t),n.stop(t+.2)}function ve(e,t){let n=e.createBuffer(1,e.sampleRate*.12,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=Math.random()*2-1;let i=e.createBufferSource(),a=e.createBiquadFilter(),o=e.createGain();i.buffer=n,a.type=`bandpass`,a.frequency.value=2400,a.Q.value=.8,i.connect(a),a.connect(o),o.connect(f),o.gain.setValueAtTime(.22,t),o.gain.exponentialRampToValueAtTime(.001,t+.14),i.start(t)}function ye(e,t,n=!1){let r=e.createBuffer(1,e.sampleRate*(n?.18:.04),e.sampleRate),i=r.getChannelData(0);for(let e=0;e<i.length;e++)i[e]=Math.random()*2-1;let a=e.createBufferSource(),o=e.createBiquadFilter(),s=e.createGain();a.buffer=r,o.type=`highpass`,o.frequency.value=9e3,a.connect(o),o.connect(s),s.connect(f),s.gain.setValueAtTime(n?.1:.07,t),s.gain.exponentialRampToValueAtTime(.001,t+(n?.18:.04)),a.start(t)}function be(e,t,n,r){let i=e.createOscillator(),a=e.createGain(),o=e.createBiquadFilter();i.type=`sawtooth`,i.frequency.value=t/2,o.type=`lowpass`,o.frequency.value=600,o.Q.value=3,i.connect(o),o.connect(a),a.connect(f),a.gain.setValueAtTime(.18,n),a.gain.setValueAtTime(.14,n+r*.7),a.gain.exponentialRampToValueAtTime(.001,n+r),i.start(n),i.stop(n+r+.05)}function xe(e,t,n,r){let i=e.createOscillator(),a=e.createGain();i.type=`square`,i.frequency.value=t,i.connect(a),a.connect(f),a.gain.setValueAtTime(.06,n),a.gain.exponentialRampToValueAtTime(.001,n+r*.9),i.start(n),i.stop(n+r)}function Se(e,t,n,r){t.forEach(t=>{let i=e.createOscillator(),a=e.createGain();i.type=`sine`,i.frequency.value=t,i.connect(a),a.connect(f),a.gain.setValueAtTime(0,n),a.gain.linearRampToValueAtTime(.04,n+.3),a.gain.setValueAtTime(.04,n+r-.3),a.gain.linearRampToValueAtTime(0,n+r),i.start(n),i.stop(n+r+.1)})}function Ce(e,t,n){if(!fe)return;let r=me[n%me.length],i=he[n%he.length];Se(e,r,t,p),be(e,r[0],t,p/2),be(e,r[0],t+p/2,p/2);for(let n=0;n<4;n++){let r=t+n*ge;(n===0||n===2)&&_e(e,r),(n===1||n===3)&&ve(e,r),ye(e,r,!1),ye(e,r+ge/2,n===1)}i.forEach((n,r)=>{xe(e,n,t+r*ge/2,ge/2*.85)}),pe=setTimeout(()=>{Ce(e,t+p,n+1)},(p-.1)*1e3)}let m=null;function we(){if(!u||m)return;let e=u.createOscillator(),t=u.createGain();e.type=`sawtooth`,e.frequency.value=60,t.gain.value=.018,e.connect(t),t.connect(u.destination),e.start(),m={osc1:e,gain:t}}function Te(e){if(!m)return;let t=60+e*80;m.osc1.frequency.setTargetAtTime(t,u.currentTime,.4),m.gain.gain.setTargetAtTime(.018+e*.012,u.currentTime,.4)}function Ee(){!u||fe||!q||!ne()||(fe=!0,f=u.createGain(),f.gain.value=an*.55,f.connect(u.destination),Ce(u,u.currentTime+.05,0))}function h(){fe=!1,clearTimeout(pe),f&&(f.gain.setTargetAtTime(0,u.currentTime,.2),setTimeout(()=>{f=null},500))}function De(){m&&(m.gain.gain.setTargetAtTime(0,u.currentTime,.15),setTimeout(()=>{try{m.osc1.stop()}catch{}m=null},400))}let g={skyTop:`#101725`,skyMid:`#28304a`,skyLow:`#5d4a4f`,fog:3422542,ambient:3159628,keyLight:16767400,warmAccent:14258767,coolAccent:9418984,floor:1383469,laneLine:5399160,arch:4608618,gem:15248462,hull:12833766,hullEmissive:3098467,stripe:15398143,glass:924194,glassEmissive:7058376,nacelle:2761754,thrust:16765562,invincible:9431264,hazardBurst:14247471,cssGold:`#e8ac4e`},Oe=Number.isFinite(navigator.hardwareConcurrency)&&navigator.hardwareConcurrency<=4,ke=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches??!1,_=new t.WebGLRenderer({canvas:c,antialias:!(o||Oe),powerPreference:`high-performance`}),Ae=o||Oe?1:1.35,v=Math.min(window.devicePixelRatio||1,Ae);_.setPixelRatio(v),e.dataset.renderScale=v.toFixed(2),_.shadowMap.enabled=!1,_.setSize(window.innerWidth,window.innerHeight);let y=new t.Scene;function je(){let e=document.createElement(`canvas`);e.width=2,e.height=256;let n=e.getContext(`2d`),r=n.createLinearGradient(0,0,0,256),i=`#${g.floor.toString(16).padStart(6,`0`)}`;return r.addColorStop(0,g.skyTop),r.addColorStop(.4,g.skyMid),r.addColorStop(.54,g.skyLow),r.addColorStop(.7,i),r.addColorStop(1,i),n.fillStyle=r,n.fillRect(0,0,2,256),new t.CanvasTexture(e)}y.background=je(),y.fog=new t.FogExp2(g.fog,.019);let b=new t.PerspectiveCamera(70,window.innerWidth/window.innerHeight,.1,300);b.position.set(0,2.8,9),b.lookAt(0,.5,0);let Me=b.position.z-6;function Ne(){let e=b.aspect,t=2*Math.atan(11/(2*Me)),n=2*Math.atan(Math.tan(t/2)/e)*(180/Math.PI);n=Math.max(70,Math.min(100,n)),b.fov=n,b.updateProjectionMatrix()}Ne();function Pe(){b.aspect=window.innerWidth/window.innerHeight,Ne(),_.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,Pe);function x(e){if(!o)return new t.MeshStandardMaterial(e);let{roughness:n,metalness:r,...i}=e;return new t.MeshLambertMaterial(i)}let Fe=new t.AmbientLight(g.ambient,2);y.add(Fe);let Ie=new t.DirectionalLight(g.keyLight,1.45);Ie.position.set(5,12,8),y.add(Ie);let Le=new t.PointLight(g.warmAccent,2.2,24);Le.position.set(-6,3,2),y.add(Le);let S=new t.Color(g.warmAccent),Re=new t.Color(g.coolAccent),C=new t.PointLight(g.coolAccent,1.8,9);y.add(C);let ze=new t.BufferGeometry,Be=o||Oe?1100:1900,Ve=new Float32Array(Be*3),He=new Float32Array(Be*3);for(let e=0;e<Be;e++){Ve[e*3]=(Math.random()-.5)*500,Ve[e*3+1]=(Math.random()-.5)*200,Ve[e*3+2]=(Math.random()-.5)*500-100;let t=Math.random();He[e*3]=t>.7?0:1,He[e*3+1]=t>.7?1:t>.4?0:.5,He[e*3+2]=1}ze.setAttribute(`position`,new t.BufferAttribute(Ve,3)),ze.setAttribute(`color`,new t.BufferAttribute(He,3));let Ue=new t.PointsMaterial({size:.5,vertexColors:!0,transparent:!0,opacity:.85}),We=new t.Points(ze,Ue);y.add(We);let Ge=new t.Group,Ke=new t.Mesh(new t.IcosahedronGeometry(10,1),new t.MeshBasicMaterial({color:11631183,transparent:!0,opacity:.34,fog:!1,depthWrite:!1}));Ke.position.set(-24,15,-128);let qe=new t.Mesh(new t.IcosahedronGeometry(5.5,1),new t.MeshBasicMaterial({color:9418984,transparent:!0,opacity:.22,fog:!1,depthWrite:!1}));qe.position.set(22,7,-102);let Je=new t.Mesh(new t.TorusGeometry(11.8,.14,5,48),new t.MeshBasicMaterial({color:g.warmAccent,transparent:!0,opacity:.36,fog:!1,depthWrite:!1}));Je.position.copy(Ke.position),Je.rotation.x=Math.PI*.32,Ge.add(Ke,qe,Je),Ke.visible=!1,qe.visible=!1,Je.visible=!1,y.add(Ge);let Ye=6.5,w=o||Oe?20:26,Xe=new Float32Array(w);for(let e=0;e<w;e++)Xe[e]=-e*5;let T=new t.Group;y.add(T);let Ze=new t.PlaneGeometry(9,5,8,1);Ze.rotateX(-Math.PI/2);let Qe=x({color:g.floor,roughness:1,metalness:0,emissive:856360}),$e=new t.InstancedMesh(Ze,Qe,w);T.add($e);let et=new t.BoxGeometry(.04,.02,5),tt=new t.MeshBasicMaterial({color:g.laneLine,transparent:!0,opacity:.76}),nt=new t.InstancedMesh(et,tt,w*9);T.add(nt);let rt=new t.BoxGeometry(.06,.06,5),it=new t.MeshBasicMaterial({color:g.warmAccent}),at=new t.MeshBasicMaterial({color:g.coolAccent}),ot=new t.InstancedMesh(rt,it,w),st=new t.InstancedMesh(rt,at,w);T.add(ot,st);let ct=new t.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.68}),lt=new t.BoxGeometry(.1,Ye,.1),E=new t.InstancedMesh(lt,ct,w*2);T.add(E);let ut=new t.BoxGeometry(9,.1,.1),D=new t.InstancedMesh(ut,ct,w);T.add(D);let dt=new t.Matrix4,ft=new t.Vector3,pt=new t.Quaternion,mt=new t.Vector3(1,1,1);function O(e,t,n,r,i){ft.set(n,r,i),dt.compose(ft,pt,mt),e.setMatrixAt(t,dt)}function ht(){for(let e=0;e<w;e++){let n=Xe[e];O($e,e,0,-1.1,n);for(let t=0;t<9;t++)O(nt,e*9+t,t-4,-1.09,n);O(ot,e,-9/2,-1.05,n),O(st,e,9/2,-1.05,n);let r=n-5/2;O(E,e*2,-9/2,Ye/2-1.1,r),O(E,e*2+1,9/2,Ye/2-1.1,r),O(D,e,0,Ye-1.1,r);let i=new t.Color(e%6==0?g.warmAccent:g.arch);E.setColorAt(e*2,i),E.setColorAt(e*2+1,i),D.setColorAt(e,i)}$e.instanceMatrix.needsUpdate=!0,nt.instanceMatrix.needsUpdate=!0,ot.instanceMatrix.needsUpdate=!0,st.instanceMatrix.needsUpdate=!0,E.instanceMatrix.needsUpdate=!0,D.instanceMatrix.needsUpdate=!0,E.instanceColor.needsUpdate=!0,D.instanceColor.needsUpdate=!0}ht(),$e.instanceMatrix.setUsage(t.StaticDrawUsage),nt.instanceMatrix.setUsage(t.StaticDrawUsage),ot.instanceMatrix.setUsage(t.StaticDrawUsage),st.instanceMatrix.setUsage(t.StaticDrawUsage),E.instanceMatrix.setUsage(t.StaticDrawUsage),D.instanceMatrix.setUsage(t.StaticDrawUsage);function gt(){let e=new t.Shape;e.moveTo(.52,0),e.quadraticCurveTo(.42,.1,.2,.13),e.lineTo(.06,.15),e.lineTo(-.12,.42),e.lineTo(-.26,.44),e.lineTo(-.2,.15),e.lineTo(-.34,.13),e.lineTo(-.46,.2),e.lineTo(-.4,.06),e.lineTo(-.4,-.06),e.lineTo(-.46,-.2),e.lineTo(-.34,-.13),e.lineTo(-.2,-.15),e.lineTo(-.26,-.44),e.lineTo(-.12,-.42),e.lineTo(.06,-.15),e.lineTo(.2,-.13),e.quadraticCurveTo(.42,-.1,.52,0);let n=new t.ExtrudeGeometry(e,{depth:.09,bevelEnabled:!0,bevelThickness:.035,bevelSize:.03,bevelSegments:2,curveSegments:8});return n.rotateX(-Math.PI/2),n.rotateY(Math.PI/2),n.center(),n}function _t(){let e=new t.Group,n=2.3,r=new t.Mesh(gt(),x({color:g.hull,emissive:g.hullEmissive,emissiveIntensity:.55,roughness:.3,metalness:.6}));r.scale.setScalar(n),e.add(r);let i=new t.Mesh(new t.BoxGeometry(n*.05,.012,n*.66),x({color:g.stripe,emissive:g.stripe,emissiveIntensity:.45,roughness:.4,metalness:.3}));i.position.set(0,n*.055,-2.3*.02),e.add(i);let a=new t.Mesh(new t.SphereGeometry(n*.13,14,10),x({color:g.glass,emissive:g.glassEmissive,emissiveIntensity:.5,roughness:.15,metalness:.7}));a.scale.set(1,.62,1.7),a.position.set(0,n*.06,-2.3*.18),e.add(a);let o=[];for(let r of[-1,1]){let i=new t.Mesh(new t.CylinderGeometry(n*.055,n*.075,n*.3,10),x({color:g.nacelle,emissive:g.warmAccent,emissiveIntensity:.2,roughness:.35,metalness:.6}));i.rotation.x=Math.PI/2,i.position.set(r*n*.19,n*.02,n*.28),e.add(i);let a=new t.Mesh(new t.ConeGeometry(n*.055,n*.3,8),new t.MeshBasicMaterial({color:g.thrust,transparent:!0,opacity:.85,blending:t.AdditiveBlending,depthWrite:!1}));a.rotation.x=Math.PI/2,a.position.set(r*n*.19,n*.02,n*.68),e.add(a),o.push(a)}let s=new t.Mesh(new t.CircleGeometry(n*.55,20),new t.MeshBasicMaterial({color:g.coolAccent,transparent:!0,opacity:.2,blending:t.AdditiveBlending,depthWrite:!1}));s.rotation.x=-Math.PI/2,s.position.y=-2.3*.09,e.add(s);let c=new t.Mesh(new t.SphereGeometry(.22,8,8),x({color:g.coolAccent,emissive:g.coolAccent,emissiveIntensity:2.8,transparent:!0,opacity:.85}));c.position.set(0,n*.02,n*.42),e.add(c);let l=new t.Mesh(new t.ConeGeometry(.2,1,8),x({color:g.coolAccent,emissive:g.coolAccent,emissiveIntensity:2.4,transparent:!0,opacity:.45}));return l.rotation.x=-Math.PI/2,l.position.set(0,n*.02,n*.72),e.add(l),e.userData.cockpit=a,e.userData.glow=c,e.userData.thrusters=o,e}let k=.3,A=_t();A.scale.setScalar(.68);let vt=A.userData.cockpit,yt=A.userData.glow,bt=A.userData.thrusters;A.position.set(0,k,6),A.frustumCulled=!1,A.traverse(e=>{e.frustumCulled=!1}),y.add(A);let xt=[],j=[],St=[x({color:10178377,emissive:4134677,roughness:.45,metalness:.45}),x({color:11692850,emissive:4596493,roughness:.45,metalness:.45}),x({color:7621479,emissive:2889511,roughness:.45,metalness:.45})],Ct=[new t.BoxGeometry(1.3,1.3,1.3),new t.OctahedronGeometry(.85),new t.TetrahedronGeometry(1),new t.IcosahedronGeometry(.75),new t.TorusGeometry(.65,.22,8,14)];function wt(){if(xt.length>0){let e=xt.pop();return e.group.visible=!0,e}let e=Math.floor(Math.random()*Ct.length),n=Math.floor(Math.random()*St.length),r=new t.Mesh(Ct[e],St[n]),i=x({color:St[n].color,emissive:St[n].color,emissiveIntensity:3,transparent:!0,opacity:.8}),a=new t.Mesh(new t.TorusGeometry(1,.04,4,20),i);a.name=`ring`;let o=new t.Group;return o.add(r),o.add(a),y.add(o),{group:o,mesh:r,ring:a}}function Tt(e){e.group.visible=!1,y.remove(e.group),xt.push(e)}for(let e=0;e<20;e++)Tt(wt());let Et=[],M=[],Dt=x({color:g.gem,emissive:13208112,emissiveIntensity:1.8,roughness:.1,metalness:.8});function Ot(){if(Et.length>0){let e=Et.pop();return e.visible=!0,y.add(e),e}let e=new t.Mesh(new t.OctahedronGeometry(.38),Dt);return y.add(e),e}function kt(e){e.visible=!1,y.remove(e),Et.push(e)}let At=o||Oe?{spark:40,gem:24}:{spark:56,gem:32},jt=new t.SphereGeometry(.12,4,4),Mt=new t.OctahedronGeometry(.06),N=[],Nt={spark:[],gem:[]};function Pt(e){let n=new t.Mesh(e===`gem`?Mt:jt,new t.MeshBasicMaterial({color:e===`gem`?g.gem:g.hazardBurst,transparent:!0,opacity:1,depthWrite:!1}));return n.visible=!1,n.frustumCulled=!1,y.add(n),n}for(let e=0;e<At.spark;e++)Nt.spark.push(Pt(`spark`));for(let e=0;e<At.gem;e++)Nt.gem.push(Pt(`gem`));function Ft(e){let t=Nt[e];if(t.length)return t.pop();for(let t=0;t<N.length;t++)if(N[t].kind===e){let e=N[t].mesh;return N.splice(t,1),e}return null}function It(e,t,n,r,i,a,o,s,c){let l=Ft(e);l&&(l.position.set(t,n,r),l.scale.setScalar(c),l.material.opacity=1,l.visible=!0,N.push({kind:e,mesh:l,vx:i,vy:a,vz:o,life:1,decay:s}))}function Lt(e,t,n){for(let r=0;r<18;r++){let r=Math.random()*Math.PI*2,i=Math.random()*Math.PI,a=Math.random()*.35+.1;It(`spark`,e,t,n,Math.sin(i)*Math.cos(r)*a,Math.sin(i)*Math.sin(r)*a,Math.cos(i)*a,.025+Math.random()*.02,.65+Math.random()*1.15)}}function Rt(e,t,n){for(let r=0;r<10;r++){let r=Math.random()*Math.PI*2;It(`gem`,e,t,n,Math.cos(r)*.18,.15+Math.random()*.1,Math.sin(r)*.18,.04,1)}}function zt(e){for(let t=N.length-1;t>=0;t--){let n=N[t];if(n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.vy-=.008*e,n.life-=n.decay*e,n.life<=0){n.mesh.visible=!1,Nt[n.kind].push(n.mesh),N.splice(t,1);continue}n.mesh.material.opacity=Math.max(0,n.life),n.mesh.scale.setScalar(n.life)}}let P={};function Bt(e,t,n=700){let r=s(`#vr-popup`);r.textContent=e,r.style.color=t,r.style.opacity=`1`,r.style.transform=`translateX(-50%) scale(1)`,clearTimeout(P.popup),P.popup=setTimeout(()=>{r.style.opacity=`0`,r.style.transform=`translateX(-50%) scale(0.8)`},n)}function Vt(e,t=150){let n=s(`#${e}`);n.style.opacity=`1`;let r=`flash-${e}`;clearTimeout(P[r]),P[r]=setTimeout(()=>{n.style.opacity=`0`},t)}let Ht=7e3,Ut=new t.CylinderGeometry(.09,.09,1.5,6);Ut.rotateX(Math.PI/2);let Wt=new t.MeshBasicMaterial({color:g.thrust,transparent:!0,opacity:.9,blending:t.AdditiveBlending,depthWrite:!1}),Gt=[],F=[];for(let e=0;e<16;e++){let e=new t.Mesh(Ut,Wt);e.visible=!1,e.frustumCulled=!1,y.add(e),Gt.push(e)}let I=0,L=0,Kt=0;function qt(e){let t=Gt.pop();t&&(t.position.set(e,k,A.position.z-1.6),t.visible=!0,F.push(t))}function Jt(e){let t=F[e];t.visible=!1,F.splice(e,1),Gt.push(t)}function Yt(){for(let e=F.length-1;e>=0;e--)Jt(e)}function Xt(e){let t=Math.round(e===`firing`?L/Ht*100:I/8*100);t!==z.power&&(R.powerFill.style.width=`${t}%`,z.power=t),e!==z.powerState&&(R.power.classList.toggle(`vr-ready`,e===`ready`),R.power.classList.toggle(`vr-firing`,e===`firing`),R.powerLabel.textContent=e===`firing`?`FIRING`:e===`ready`?o?`TAP TO FIRE`:`SPACE TO FIRE`:`PULSE`,z.powerState=e)}function Zt(){V===`playing`&&(L>0||I<8||(L=Ht,Kt=0,Xt(`firing`),Bt(`PULSE CANNON`,g.cssGold,900),de()))}let R={score:s(`#vr-scorehud`),level:s(`#vr-levelhud`),speedFill:s(`#vr-speedfill`),speedLines:s(`#vr-speedlines`),warnFlash:s(`#vr-warningflash`),combo:s(`#vr-combodisplay`),comboText:s(`#vr-combotext`),power:s(`#vr-power`),powerFill:s(`#vr-powerfill`),powerLabel:s(`#vr-powerlabel`)},z={speedPct:-1,score:-1,lines:-1,warn:-1,power:-1,powerState:``},B=[-3.2,0,3.2],V=`menu`,H=0,U=parseInt(localStorage.getItem(`vrBest`)||`0`,10),Qt=3,W=1,$t=0,G=0,en=.32,tn=.85,nn=0,K=0,rn=0,q=!0,J=!0,an=.7,Y=.8,on=localStorage.getItem(`vrName`)||`PILOT`;function sn(){try{return JSON.parse(localStorage.getItem(`vrScores`)||`[]`)}catch{return[]}}function cn(e,t,n,r){let i=sn();i.push({name:e.toUpperCase().slice(0,10),score:t,level:n,gems:r,date:new Date().toLocaleDateString()}),i.sort((e,t)=>t.score-e.score),i.splice(5),localStorage.setItem(`vrScores`,JSON.stringify(i))}function ln(){window.confirm(`Clear all high scores?`)&&(localStorage.removeItem(`vrScores`),un(),ce())}function un(){let e=sn(),t=s(`#vr-hstable`);if(!e.length){t.innerHTML=`<div class="vr-hs-empty">NO SCORES YET<br>BE THE FIRST PILOT!</div>`;return}let n=[`vr-gold-rank`,`vr-silver`,`vr-bronze`,`vr-other`,`vr-other`],r=[`1ST`,`2ND`,`3RD`,`4TH`,`5TH`];t.innerHTML=e.map((e,t)=>`
      <div class="vr-hs-row">
      ...
      </div>`).join(``)}let dn=[`vr-menuscreen`,`vr-highscorescreen`,`vr-settingsscreen`,`vr-howscreen`,`vr-countdownscreen`,`vr-pausescreen`,`vr-gameoverscreen`];function X(e){ce(),dn.forEach(e=>{let t=s(`#${e}`);t&&(t.style.display=`none`)});let t=s(`#${e}`);t&&(t.style.display=`flex`),e===`vr-highscorescreen`&&un(),e===`vr-settingsscreen`&&(s(`#vr-nameinput`).value=on,s(`#vr-musicvol`).value=Math.round(an*100),s(`#vr-sfxvol`).value=Math.round(Y*100),s(`#vr-musictoggle`).textContent=q?`ON`:`OFF`,s(`#vr-musictoggle`).className=`vr-toggle-btn `+(q?`vr-on`:`vr-off`),s(`#vr-sfxtoggle`).textContent=J?`ON`:`OFF`,s(`#vr-sfxtoggle`).className=`vr-toggle-btn `+(J?`vr-on`:`vr-off`))}function fn(){on=s(`#vr-nameinput`).value||`PILOT`,localStorage.setItem(`vrName`,on)}function pn(e){an=e/100,f&&f.gain.setTargetAtTime(an*.55,u.currentTime,.1)}function mn(e){Y=e/100}function hn(){q=!q,s(`#vr-musictoggle`).textContent=q?`ON`:`OFF`,s(`#vr-musictoggle`).className=`vr-toggle-btn `+(q?`vr-on`:`vr-off`),q?V===`playing`&&(ee(),Ee()):h()}function gn(){J=!J,s(`#vr-sfxtoggle`).textContent=J?`ON`:`OFF`,s(`#vr-sfxtoggle`).className=`vr-toggle-btn `+(J?`vr-on`:`vr-off`)}function _n(){ce(),n?.()}let vn=!1,yn=0,Z=0,Q=0,bn=0,$=0,xn=0,Sn=0,Cn=0,wn=1,Tn=0,En=1,Dn={left:!1,right:!1};s(`#vr-besthud`).textContent=U,s(`#vr-menubest`).textContent=`\u{1F3C6} BEST: ${U}`,U>0&&(s(`#vr-menubest`).style.opacity=`1`);function On(e){if((e.key===`ArrowLeft`||e.key===`a`||e.key===`A`)&&(Dn.left=!0),(e.key===`ArrowRight`||e.key===`d`||e.key===`D`)&&(Dn.right=!0),(e.key===`p`||e.key===`P`||e.key===`Escape`)&&(V===`playing`||V===`paused`)&&dr(),e.key===` `&&V===`playing`){e.preventDefault(),Zt();return}(e.key===` `||e.key===`Enter`)&&(V===`gameover`||V===`menu`)&&(e.preventDefault(),lr())}function kn(e){(e.key===`ArrowLeft`||e.key===`a`||e.key===`A`)&&(Dn.left=!1),(e.key===`ArrowRight`||e.key===`d`||e.key===`D`)&&(Dn.right=!1)}document.addEventListener(`keydown`,On),document.addEventListener(`keyup`,kn);let An=1,jn=!1,Mn=Array.from(e.querySelectorAll(`.vr-lane-dot`));function Nn(){Mn.forEach((e,t)=>e.classList.toggle(`vr-active`,t===An))}function Pn(e){if(jn)return;let t=An+(e===`left`?-1:1);t<0||t>=B.length||(An=t,nn=B[An],Nn(),jn=!0,J&&u&&d(e===`left`?300:340,`sine`,.04,.03*Y),In(e))}let Fn={};function In(e){let t=s(e===`left`?`#vr-btnleft`:`#vr-btnright`);t&&(t.classList.add(`vr-pressed`),clearTimeout(Fn[e]),Fn[e]=setTimeout(()=>t.classList.remove(`vr-pressed`),140))}let Ln=()=>Math.max(44,(c.clientWidth||window.innerWidth)*.07),Rn=null,zn=0,Bn=0,Vn=!1,Hn=0,Un=0,Wn=0,Gn=!1;function Kn(){Gn||(Gn=!0,s(`#vr-swipehint`)?.classList.add(`vr-faded`))}function qn(e){if(ee(),V===`playing`&&Rn===null){Rn=e.pointerId,zn=e.clientX,Bn=e.clientY,Hn=e.clientX,Un=e.clientY,Wn=performance.now(),Vn=!1;try{c.setPointerCapture(e.pointerId)}catch{}}}function Jn(e){if(e.pointerId!==Rn||V!==`playing`)return;let t=e.clientX-zn,n=Ln();Math.abs(t)<n||Math.abs(e.clientY-Bn)>Math.abs(t)*1.2||(Pn(t<0?`left`:`right`),Vn=!0,Kn(),zn=e.clientX,Bn=e.clientY)}function Yn(e){if(e.pointerId!==Rn)return;try{c.releasePointerCapture(e.pointerId)}catch{}if(Rn=null,e.type!==`pointerup`)return;let t=Math.hypot(e.clientX-Hn,e.clientY-Un);!Vn&&t<16&&performance.now()-Wn<320&&Zt()}c.addEventListener(`pointerdown`,qn),c.addEventListener(`pointermove`,Jn),c.addEventListener(`pointerup`,Yn),c.addEventListener(`pointercancel`,Yn);function Xn(e=Math.floor(Math.random()*B.length),n=-90){let r=wt(),i=B[e],a=k+(Math.random()-.5)*.8;r.group.position.set(i,a,n),r.group.visible=!0,y.add(r.group),r.mesh.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,0),r.ring.rotation.x=Math.random(),r.rotSpd=new t.Vector3((Math.random()-.5)*.06,(Math.random()-.5)*.06,(Math.random()-.5)*.04),r.lane=e,r.warned=!1,j.push(r)}function Zn(e=Math.floor(Math.random()*B.length),t=-95){let n=Ot();n.position.set(B[e],k+(Math.random()-.5)*.7,t),n.rotation.set(0,0,0),M.push(n)}function Qn(){let e=Math.max(0,wn-1),t=Math.min(B.length-1,wn+1),n=e+Math.floor(Math.random()*(t-e+1));return wn=n,n}function $n(){let e=Qn(),t=[0,1,2].filter(t=>t!==e);Math.random()<.14+G*.46?(Xn(t[0]),Xn(t[1])):Xn(t[Math.floor(Math.random()*t.length)]),Math.random()<.76&&Zn(e,-94)}function er(){for(let e=1;e<=3;e++)s(`#vr-h${e}`).classList.toggle(`vr-dead`,e>Qt)}let tr=0,nr=null,rr=0,ir=0;function ar(t){if(V!==`playing`||t>=50||v<=.85||(rr+=t,ir++,ir<180))return;let n=rr/ir;rr=0,ir=0,!(n<=21)&&(v=Math.max(.85,v-.15),_.setPixelRatio(v),_.setSize(window.innerWidth,window.innerHeight),e.dataset.renderScale=v.toFixed(2))}function or(e){nr=requestAnimationFrame(or);let t=Math.min(Math.max(e-tr,0),50),n=t/16.667;if(tr=e,$+=n/60,ar(t),We.rotation.y+=8e-5*n,ke||(Ge.rotation.y=Math.sin($*.08)*.035,Je.rotation.z+=15e-5*n),V===`playing`&&(Tn=(Tn+en*n)%5,T.position.z=Tn),V===`menu`||V===`gameover`){A.position.y=k+Math.sin($*1.2)*.12,A.rotation.y=Math.sin($*.4)*.18,b.position.x=Math.sin($*.2)*1.2,b.lookAt(0,.5,0),C.position.copy(A.position),zt(n),_.render(y,b);return}if(V===`paused`||V===`countdown`){_.render(y,b);return}xn+=n/60,Dn.left&&Pn(`left`),Dn.right&&Pn(`right`);let r=n/60,i=1-Math.exp(-16*r),a=K;K+=i*(nn-K),K=Math.max(-3.2,Math.min(3.2,K)),jn&&Math.abs(K-nn)<.12&&(jn=!1);let o=-((K-a)/r)*.01;rn+=(o-rn)*i*1.2,A.position.x=K,A.position.y=k+Math.sin($*2)*.04,A.rotation.z=Math.max(-.45,Math.min(.45,rn)),A.rotation.y=rn*.12,yt.material.emissiveIntensity=3.2+Math.sin($*25)*.8;for(let e=0;e<bt.length;e++){let t=bt[e];t.scale.z=.85+Math.sin($*22+e*1.7)*.22,t.material.opacity=.7+Math.sin($*19+e)*.15}if(C.position.copy(A.position),C.position.z+=1,vn){yn-=n;let e=.5+.5*Math.sin(yn*.4);vt.material.emissive.setHex(g.invincible),vt.material.emissiveIntensity=2+e*3,yt.material.emissive.setHex(g.invincible),yt.material.emissiveIntensity=4+e*4,C.color.setHex(g.invincible),C.intensity=4+e*3,yn<=0&&(vn=!1,vt.material.emissive.setHex(g.glassEmissive),vt.material.emissiveIntensity=.5,yt.material.emissive.setHex(g.coolAccent),yt.material.emissiveIntensity=4,C.color.setHex(g.coolAccent),C.intensity=3)}en=Math.min(tn,.32+xn*.006),G=(en-.32)/(tn-.32),H=Math.floor(xn*15+$t*8+Sn),W=Math.min(10,Math.floor(G*9)+1),W!==En&&(oe(),R.level.textContent=`LV ${W}`,En=W);let s=Math.round(G*100);s!==z.speedPct&&(R.speedFill.style.width=`${s}%`,z.speedPct=s),H!==z.score&&(R.score.textContent=H,z.score=H);let c=G>.5?Math.round((G-.5)*80)/100:0;c!==z.lines&&(R.speedLines.style.opacity=String(c),z.lines=c);let l=Math.sin($*.4);Le.position.x=l*5.5;let u=.5+.5*Math.cos($*.3);Le.color.setRGB(S.r+(Re.r-S.r)*u,S.g+(Re.g-S.g)*u,S.b+(Re.b-S.b)*u),Le.intensity=2.2+Math.sin($*2)*.55,bn>0&&(bn-=n,bn<=0&&(Q=0,R.combo.style.opacity=`0`));let ee=Math.max(48,82-W*3.2);Cn-=n,Cn<=0&&($n(),Cn=ee);let te=!1;for(let e=j.length-1;e>=0;e--){let t=j[e];if(t.group.position.z+=(en+.28)*n,t.mesh.rotation.x+=t.rotSpd.x*n,t.mesh.rotation.y+=t.rotSpd.y*n,t.ring.rotation.z+=.04*n,t.group.position.z>-30&&t.group.position.z<-8){let e=.4+Math.sin($*12)*.3;t.ring.material.emissiveIntensity=2+e*3,Math.abs(t.group.position.x-K)<1.5&&(te=!0)}else t.ring.material.emissiveIntensity=1;if(t.group.position.z>14){Tt(t),j.splice(e,1);continue}if(!vn&&t.group.position.z>4&&t.group.position.z<9){let n=Math.abs(t.group.position.x-A.position.x),r=Math.abs(t.group.position.y-A.position.y);if(n<.78&&r<.72){if(Lt(t.group.position.x,t.group.position.y,t.group.position.z),Tt(t),j.splice(e,1),Qt--,er(),se(),Vt(`vr-hitflash`,200),Z=20,Q=0,R.combo.style.opacity=`0`,vn=!0,yn=100,Qt<=0){ur();return}continue}n<1.8&&r<1.8&&!t.warned&&(t.warned=!0,re(),Q++,bn=120,Q>=2&&(R.comboText.textContent=`COMBO x${Q}`,R.combo.style.opacity=`1`,Sn+=Q*5))}}let ne=te?Math.round((.4+Math.sin($*15)*.3)*20)/20:0;ne!==z.warn&&(R.warnFlash.style.opacity=String(ne),z.warn=ne);let d=1e3/60*n;L>0&&(L=Math.max(0,L-d),Kt-=d,Kt<=0&&(Kt=130,qt(K),le()),Xt(L>0?`firing`:`idle`),L===0&&(I=0));for(let e=F.length-1;e>=0;e--){let t=F[e],r=t.position.z;if(t.position.z-=1.15*n,t.position.z<-96){Jt(e);continue}let i=!1;for(let e=j.length-1;e>=0;e--){let n=j[e],a=n.group.position.z;if(!(a>r+1.1||a<t.position.z-1.1)&&!(Math.abs(n.group.position.x-t.position.x)>1.25)){Lt(n.group.position.x,n.group.position.y,n.group.position.z),Tt(n),j.splice(e,1),Sn+=20,ue(),i=!0;break}}i&&Jt(e)}for(let e=M.length-1;e>=0;e--){let t=M[e];if(t.position.z+=(en+.15)*n,t.rotation.y+=.06*n,t.rotation.x+=.04*n,t.position.z>14){kt(t),M.splice(e,1);continue}if(t.position.z>4&&t.position.z<9){let n=Math.abs(t.position.x-A.position.x),r=Math.abs(t.position.y-A.position.y);if(n<.9&&r<.86){ie(),Rt(t.position.x,t.position.y,t.position.z),Vt(`vr-gemflash`,120),$t++,L===0&&I<8&&(I++,Xt(I>=8?`ready`:`idle`),I===8&&(de(),Bt(`PULSE READY`,g.cssGold,900)));let n=25*Math.max(1,Math.floor(Q/2)+1);Sn+=n,Bt(`+${n}`,g.cssGold,600),kt(t),M.splice(e,1)}}}zt(n);let ae=K*.45;b.position.x+=(ae-b.position.x)*.08*n,b.position.y+=(2.8-b.position.y)*.04*n,Z>0&&(b.position.x+=Math.sin($*60)*(Z*.018),b.position.y+=Math.cos($*55)*(Z*.012),Z-=n*1.8,Z<0&&(Z=0)),b.position.z=9,b.lookAt(K*.5,.8,0),Te(G),_.render(y,b)}function sr(){j.forEach(e=>Tt(e)),j.length=0,M.forEach(e=>kt(e)),M.length=0,Yt(),N.forEach(e=>{e.mesh.visible=!1,Nt[e.kind].push(e.mesh)}),N.length=0}let cr=null;function lr(){ee(),ce(),[`vr-menuscreen`,`vr-gameoverscreen`,`vr-pausescreen`].forEach(e=>{s(`#${e}`).style.display=`none`}),s(`#vr-countdownscreen`).style.display=`flex`,s(`#vr-hud`).style.display=`none`,s(`#vr-speedbar`).style.display=`none`,s(`#vr-power`).style.display=`none`,s(`#vr-pausebtn`).style.display=`none`,s(`#vr-thumbcontrols`).style.display=`none`,s(`#vr-laneindicator`).style.display=`none`,sr(),H=0,Qt=3,$t=0,W=1,En=1,I=0,L=0,Kt=0,z.power=-1,z.powerState=``,Xt(`idle`),s(`#vr-levelhud`).textContent=`LV 1`,xn=0,Sn=0,en=.32,G=0,Tn=0,T.position.z=0,nn=0,K=0,rn=0,An=1,jn=!1,Nn(),vn=!1,A.visible=!0,Q=0,bn=0,Z=0,Cn=82,wn=1,er(),R.combo.style.opacity=`0`,s(`#vr-warningflash`).style.opacity=`0`,s(`#vr-speedlines`).style.opacity=`0`,V=`countdown`;let e=3,t=s(`#vr-countdownnum`);function n(){t.textContent=e>0?String(e):`GO!`,t.style.animation=`none`,t.offsetHeight,t.style.animation=`vrCountPulse 0.9s ease-out`,e>0?d(440,`square`,.1,.1):d(880,`square`,.15,.15),e--,cr=setTimeout(e>=0?n:()=>{s(`#vr-countdownscreen`).style.display=`none`,s(`#vr-hud`).style.display=`flex`,s(`#vr-speedbar`).style.display=`flex`,s(`#vr-power`).style.display=`flex`,s(`#vr-pausebtn`).style.display=`flex`,s(`#vr-laneindicator`).style.display=`flex`,o&&(s(`#vr-thumbcontrols`).style.display=`block`,Gn=!1,s(`#vr-swipehint`)?.classList.remove(`vr-faded`)),V=`playing`,we(),Ee()},950)}n()}function ur(){V=`gameover`,ae(),De(),h(),Lt(A.position.x,A.position.y,A.position.z),Lt(A.position.x,A.position.y,A.position.z),A.visible=!1,Z=35;let e=H>U;e&&(U=H,localStorage.setItem(`vrBest`,String(U)),s(`#vr-besthud`).textContent=U,s(`#vr-menubest`).textContent=`\u{1F3C6} BEST: ${U}`),cn(on,H,W,$t),s(`#vr-goscore`).textContent=H,s(`#vr-golevel`).textContent=W,s(`#vr-gogems`).textContent=$t,s(`#vr-gobest`).textContent=U,s(`#vr-newbestbadge`).style.display=e?`block`:`none`,P.gameover=setTimeout(()=>{s(`#vr-thumbcontrols`).style.display=`none`,s(`#vr-laneindicator`).style.display=`none`,s(`#vr-pausebtn`).style.display=`none`,s(`#vr-hud`).style.display=`none`,s(`#vr-speedbar`).style.display=`none`,s(`#vr-power`).style.display=`none`,s(`#vr-gameoverscreen`).style.display=`flex`},600)}function dr(){V===`playing`?(V=`paused`,ce(),De(),h(),s(`#vr-pausescreen`).style.display=`flex`,s(`#vr-pausebtn`).textContent=`▶`):V===`paused`&&(V=`playing`,ce(),ee(),we(),Ee(),s(`#vr-pausescreen`).style.display=`none`,s(`#vr-pausebtn`).textContent=`⏸️`)}function fr(){V=`menu`,De(),h(),sr(),A.visible=!0,s(`#vr-hud`).style.display=`none`,s(`#vr-speedbar`).style.display=`none`,s(`#vr-power`).style.display=`none`,s(`#vr-pausebtn`).style.display=`none`,s(`#vr-thumbcontrols`).style.display=`none`,s(`#vr-laneindicator`).style.display=`none`,s(`#vr-warningflash`).style.opacity=`0`,s(`#vr-speedlines`).style.opacity=`0`,s(`#vr-menubest`).style.opacity=U>0?`1`:`0`,s(`#vr-menubest`).textContent=`\u{1F3C6} BEST: ${U}`,X(`vr-menuscreen`)}let pr=[[`#vr-btnplay`,`click`,lr],[`#vr-btnscores`,`click`,()=>X(`vr-highscorescreen`)],[`#vr-btnsettings`,`click`,()=>X(`vr-settingsscreen`)],[`#vr-btnhow`,`click`,()=>X(`vr-howscreen`)],[`#vr-btnexit`,`click`,_n],[`#vr-btnclearscores`,`click`,ln],[`#vr-btnhsback`,`click`,()=>X(`vr-menuscreen`)],[`#vr-btnsetback`,`click`,()=>X(`vr-menuscreen`)],[`#vr-btnhowback`,`click`,()=>X(`vr-menuscreen`)],[`#vr-btnresume`,`click`,dr],[`#vr-btnpausesettings`,`click`,()=>{X(`vr-settingsscreen`),V=`menu`}],[`#vr-btnpausemenu`,`click`,fr],[`#vr-btnagain`,`click`,lr],[`#vr-btngoscores`,`click`,()=>X(`vr-highscorescreen`)],[`#vr-btngomenu`,`click`,fr],[`#vr-pausebtn`,`click`,dr]];return pr.forEach(([e,t,n])=>s(e)?.addEventListener(t,n)),s(`#vr-nameinput`)?.addEventListener(`input`,fn),s(`#vr-musicvol`)?.addEventListener(`input`,e=>pn(e.target.value)),s(`#vr-sfxvol`)?.addEventListener(`input`,e=>mn(e.target.value)),s(`#vr-musictoggle`)?.addEventListener(`click`,hn),s(`#vr-sfxtoggle`)?.addEventListener(`click`,gn),tr=performance.now(),nr=requestAnimationFrame(or),{syncAppAudio(){ne()?q&&Ee():h()},dispose(){if(cancelAnimationFrame(nr),window.removeEventListener(`resize`,Pe),document.removeEventListener(`keydown`,On),document.removeEventListener(`keyup`,kn),c.removeEventListener(`pointerdown`,qn),c.removeEventListener(`pointermove`,Jn),c.removeEventListener(`pointerup`,Yn),c.removeEventListener(`pointercancel`,Yn),pr.forEach(([e,t,n])=>s(e)?.removeEventListener(t,n)),Object.values(P).forEach(e=>clearTimeout(e)),Object.values(Fn).forEach(e=>clearTimeout(e)),clearTimeout(pe),clearTimeout(cr),h(),De(),u)try{u.close()}catch{}y.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),_.dispose(),i(_)}}}function ne({onBack:e}){let t=(0,a.useRef)(null),n=(0,a.useRef)(e);n.current=e;let{sfxEnabled:i}=r(),s=(0,a.useRef)(null),c=(0,a.useRef)(i);return c.current=i,(0,a.useEffect)(()=>{let e=t.current;if(!e)return;let r=!1;return e.innerHTML=ee,l().then(t=>{r||!e.isConnected||(s.current=te(e,t,{onBack:()=>n.current?.(),isAppSfxOn:()=>c.current,isAppMusicOn:()=>!0}))}).catch(()=>{r||(e.innerHTML=`<div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;text-align:center;padding:24px;color:#ffe6b0;font-family:sans-serif">Requires an internet connection to load Void Runner.</div>`)}),()=>{r=!0,s.current?.dispose(),s.current=null,e.innerHTML=``}},[]),(0,a.useEffect)(()=>{s.current?.syncAppAudio?.()},[i]),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(`style`,{children:u}),(0,o.jsx)(`div`,{className:`vr-root mode-void`,ref:t})]})}export{ne as default};