import{a as e,n as t,t as n}from"./jsx-runtime-DIAExeAg.js";import{$ as r,Ct as i,Ht as a,I as o,L as s,Mt as c,Q as l,Vt as ee,dt as u,ft as te,h as ne,l as d,m as re,mt as f,t as ie,u as p,wt as m,yt as ae}from"./three.module-8PcBWYK_.js";import{r as oe}from"./c3dViewport-D3K1ZAxX.js";var h=e(t()),g=n(),_=1.35,se=.36,v=.8,ce=3.2,le=3.2,y=6,ue=3.6;function de(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random()*2-1,o=Math.random()*Math.PI*2,s=Math.sqrt(1-e*e),c=t*(.9+.1*Math.random());n[a*3]=s*Math.cos(o)*c,n[a*3+1]=e*c,n[a*3+2]=s*Math.sin(o)*c,r[a]=Math.random(),i[a]=.6+Math.random()}let a=new p;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function fe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let o=a/e*Math.PI*2+Math.random()*.04,s=(Math.random()-.5)*.22,c=t*(.96+Math.random()*.1);n[a*3]=Math.cos(o)*c,n[a*3+1]=Math.sin(o)*c*.42+s*c,n[a*3+2]=Math.sin(o)*c*.18,r[a]=Math.random(),i[a]=.7+Math.random()*1.2}let a=new p;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function pe(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return Math.abs(t)%1e3/1e3}var b=(0,h.forwardRef)(function({planets:e},t){let n=(0,h.useRef)(null),b=(0,h.useRef)({syncPlanets:()=>{},dissolvePlanet:()=>{},reformPlanet:()=>{},pulseCenter:()=>{}});return(0,h.useImperativeHandle)(t,()=>({dissolvePlanet:e=>b.current.dissolvePlanet(e),reformPlanet:e=>b.current.reformPlanet(e),pulseCenter:()=>b.current.pulseCenter()}),[]),(0,h.useEffect)(()=>{let e=n.current;if(!e)return;let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,h=window.matchMedia(`(pointer: fine)`).matches,g=h?1:1.45,x=new i,S=new u(55,1,.1,200);S.position.set(0,0,7);let C=new ie({antialias:!0});C.setPixelRatio(Math.min(window.devicePixelRatio||1,h?1.5:1.35)),C.setClearColor(0,1),C.domElement.style.display=`block`,e.appendChild(C.domElement);let me=de(h?22e3:16e3,_),he=[],ge=[];for(let e=0;e<y;e++)he.push(new a),ge.push(-99);let w=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1},uTouches:{value:he},uStarts:{value:ge}},vertexShader:`
      ...
      `}),T=new f(me,w);x.add(T);let _e=fe(h?220:480,_*1.38),E=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        uniform float uBoost;
      ...
      `}),D=new f(_e,E);x.add(D);let ve=new te(_*(h?3.6:5.2),_*(h?3.6:5.2)),O=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),Ce=new f(P,F);Ce.frustumCulled=!1,Ce.visible=!t,x.add(Ce);let I=new l(new c(_*1.12,16,16),new r({visible:!1}));x.add(I);let L=h?700:900,R=new Float32Array(L*3),we=new Float32Array(L),Te=new Float32Array(L),Ee=new Float32Array(L),De=new Float32Array(L);for(let e=0;e<L;e++){let t=Math.random()*2-1,n=Math.random()*Math.PI*2,r=Math.sqrt(1-t*t),i=25+Math.random()*45;R[e*3]=r*Math.cos(n)*i,R[e*3+1]=t*i,R[e*3+2]=r*Math.sin(n)*i,we[e]=Math.random()*Math.PI*2,Te[e]=.2+Math.random()*1.8,Ee[e]=Math.random()<.35?1:.25+Math.random()*.4,De[e]=.5+Math.random()*1.3}let z=new p;z.setAttribute(`position`,new d(R,3)),z.setAttribute(`aPhase`,new d(we,1)),z.setAttribute(`aSpeed`,new d(Te,1)),z.setAttribute(`aDepth`,new d(Ee,1)),z.setAttribute(`aSize`,new d(De,1));let B=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
      ...
      `});x.add(new f(z,B));let V=h?0:350,H=new Float32Array(V*3),Oe=new Float32Array(V),ke=new Float32Array(V);for(let e=0;e<V;e++)H[e*3]=(Math.random()-.5)*28,H[e*3+1]=(Math.random()-.5)*22,H[e*3+2]=(Math.random()-.5)*18-2,Oe[e]=Math.random(),ke[e]=1.2+Math.random()*2.8;let U=new p;U.setAttribute(`position`,new d(H,3)),U.setAttribute(`aRand`,new d(Oe,1)),U.setAttribute(`aSize`,new d(ke,1));let W=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        varying float vAlpha;
