import{$ as e,Bt as t,C as n,E as r,Ht as i,It as a,Q as o,Rt as s,h as c,lt as l,u,wt as d,zt as f}from"./three.module-MEH2mPKQ.js";var p={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};w.BlurDirectionX=new f(1,0),w.BlurDirectionY=new f(0,1);function T(){try{return window.matchMedia(`(pointer: coarse)`).matches||window.matchMedia(`(hover: none)`).matches}catch{return!1}}function E(e,t){return e>=900||e/Math.max(1,t)>=1.2&&e>=700}export{x as a,S as i,E as n,w as r,T as t};