import{a as e,n as t,t as n}from"./jsx-runtime-DIAExeAg.js";import{$t as r,Bt as i,Dt as a,H as o,Mt as s,Qt as c,St as l,V as ee,_ as u,bt as te,f as d,it as ne,jt as re,p as f,rt as ie,t as ae,v as oe,yt as se}from"./three.module-Ua8PzK3C.js";import{r as ce}from"./c3dViewport-D3K1ZAxX.js";var p=e(t()),m=n(),h=1.35,le=.36,g=.8,ue=3.2,de=3.2,_=6,fe=3.6;function pe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random()*2-1,o=Math.random()*Math.PI*2,s=Math.sqrt(1-e*e),c=t*(.9+.1*Math.random());n[a*3]=s*Math.cos(o)*c,n[a*3+1]=e*c,n[a*3+2]=s*Math.sin(o)*c,r[a]=Math.random(),i[a]=.6+Math.random()}let a=new f;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function me(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let o=a/e*Math.PI*2+Math.random()*.04,s=(Math.random()-.5)*.22,c=t*(.96+Math.random()*.1);n[a*3]=Math.cos(o)*c,n[a*3+1]=Math.sin(o)*c*.42+s*c,n[a*3+2]=Math.sin(o)*c*.18,r[a]=Math.random(),i[a]=.7+Math.random()*1.2}let a=new f;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function he(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return Math.abs(t)%1e3/1e3}var v=(0,p.forwardRef)(function({planets:e},t){let n=(0,p.useRef)(null),[v,ge]=(0,p.useState)(0),_e=(0,p.useRef)(!1),[y,b]=(0,p.useState)(!1);(0,p.useEffect)(()=>{let e=()=>{let e=document.documentElement.dataset.homeTheme===`light`;_e.current=e,b(e)};e();let t=new MutationObserver(e);return t.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-home-theme`]}),()=>t.disconnect()},[]);let x=(0,p.useRef)({syncPlanets:()=>{},dissolvePlanet:()=>{},reformPlanet:()=>{},pulseCenter:()=>{},setRunning:()=>{}});return(0,p.useImperativeHandle)(t,()=>({dissolvePlanet:e=>x.current.dissolvePlanet(e),reformPlanet:e=>x.current.reformPlanet(e),pulseCenter:()=>x.current.pulseCenter(),setRunning:e=>x.current.setRunning(e)}),[]),(0,p.useEffect)(()=>{let e=n.current;if(!e)return;let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,p=window.matchMedia(`(pointer: fine)`).matches,m=p?1:1.45,v=new re,y=new se(55,1,.1,200);y.position.set(0,0,7);let b=new ae({antialias:!0,alpha:!0}),ve=e=>{e.preventDefault(),cancelAnimationFrame(Z),Z=0},ye=()=>{ge(e=>e+1)};b.domElement.addEventListener(`webglcontextlost`,ve,!1),b.domElement.addEventListener(`webglcontextrestored`,ye,!1),b.setPixelRatio(Math.min(window.devicePixelRatio||1,p?1.5:1.35)),b.setClearColor(0,0),b.domElement.style.display=`block`,e.appendChild(b.domElement);let be=pe(p?22e3:16e3,h),xe=[],Se=[];for(let e=0;e<_;e++)xe.push(new r),Se.push(-99);let S=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:m},uBreath:{value:1},uLight:{value:0},uTouches:{value:xe},uStarts:{value:Se}},vertexShader:`
      ...
      `}),C=new l(be,S);v.add(C);let Ce=new s({uniforms:{uNow:{value:0}},vertexShader:`
        varying vec3 vNv;
        varying vec3 vObj;
        varying vec3 vView;
        void main() {
      ...
      `}),w=new ie(new i(h*.98,64,48),Ce);w.visible=!1,v.add(w);let we=me(p?220:480,h*1.38),T=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:m},uBreath:{value:1},uLight:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        uniform float uBoost;
      ...
      `}),E=new l(we,T);v.add(E);let Te=new te(h*(p?3.6:5.2),h*(p?3.6:5.2)),D=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:m},uBreath:{value:1},uLight:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),Ee=new ie(Te,D);v.add(Ee);let O=[{r:h*1.55,speed:.5,tiltX:.55,tiltZ:.3,col:[1,.85,.58]},{r:h*1.85,speed:-.36,tiltX:-.72,tiltZ:.18,col:[.62,.85,1]},{r:h*2.15,speed:.27,tiltX:.24,tiltZ:-.6,col:[.85,.7,1]}],k=p?48:60,A=O.length*k,De=new Float32Array(A*3),Oe=new Float32Array(A),j=new Float32Array(A*4),ke=new Float32Array(A*2),M=new Float32Array(A*3);for(let e=0;e<O.length;e++){let t=O[e],n=e/O.length*Math.PI*2;for(let r=0;r<k;r++){let i=e*k+r;Oe[i]=r/(k-1),j[i*4]=t.r,j[i*4+1]=t.speed,j[i*4+2]=n,j[i*4+3]=n*2.7,ke[i*2]=t.tiltX,ke[i*2+1]=t.tiltZ,M[i*3]=t.col[0],M[i*3+1]=t.col[1],M[i*3+2]=t.col[2]}}let N=new f;N.setAttribute(`position`,new d(De,3)),N.setAttribute(`aT`,new d(Oe,1)),N.setAttribute(`aOrb`,new d(j,4)),N.setAttribute(`aTilt`,new d(ke,2)),N.setAttribute(`aCol`,new d(M,3));let P=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:m}},vertexShader:`
        attribute float aT;
        attribute vec4 aOrb;
      ...
      `}),Ae=new l(N,P);Ae.frustumCulled=!1,Ae.visible=!t,v.add(Ae);let F=new ie(new i(h*1.12,16,16),new ne({visible:!1}));v.add(F);let I=p?700:900,L=new Float32Array(I*3),je=new Float32Array(I),Me=new Float32Array(I),Ne=new Float32Array(I),Pe=new Float32Array(I);for(let e=0;e<I;e++){let t=Math.random()*2-1,n=Math.random()*Math.PI*2,r=Math.sqrt(1-t*t),i=25+Math.random()*45;L[e*3]=r*Math.cos(n)*i,L[e*3+1]=t*i,L[e*3+2]=r*Math.sin(n)*i,je[e]=Math.random()*Math.PI*2,Me[e]=.2+Math.random()*1.8,Ne[e]=Math.random()<.35?1:.25+Math.random()*.4,Pe[e]=.5+Math.random()*1.3}let R=new f;R.setAttribute(`position`,new d(L,3)),R.setAttribute(`aPhase`,new d(je,1)),R.setAttribute(`aSpeed`,new d(Me,1)),R.setAttribute(`aDepth`,new d(Ne,1)),R.setAttribute(`aSize`,new d(Pe,1));let z=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
      ...
      `});v.add(new l(R,z));let B=p?0:350,V=new Float32Array(B*3),Fe=new Float32Array(B),Ie=new Float32Array(B);for(let e=0;e<B;e++)V[e*3]=(Math.random()-.5)*28,V[e*3+1]=(Math.random()-.5)*22,V[e*3+2]=(Math.random()-.5)*18-2,Fe[e]=Math.random(),Ie[e]=1.2+Math.random()*2.8;let H=new f;H.setAttribute(`position`,new d(V,3)),H.setAttribute(`aRand`,new d(Fe,1)),H.setAttribute(`aSize`,new d(Ie,1));let U=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        varying float vAlpha;
    ...
    `}),r=new l(K,n);return v.add(r),{points:r,mat:n,phase:t}}function He(t){let n=e.clientWidth||1,i=e.clientHeight||1,a=2*(y.position.z-ue)*Math.tan(y.fov*Math.PI/360)/i,o=Math.min(.9*n,560)*a,s=Math.min(.68*i,620)*a,c=K.getAttribute(`aPaper`),l=t.points.position,ee=t.frozenRot,u=new r,te=new r(0,1,0);for(let e=0;e<Be;e++){let t,n;if(e%3==0){let e=Math.random()*2*(o+s);e<o?(t=e-o/2,n=-s/2):e<o+s?(t=o/2,n=e-o-s/2):e<2*o+s?(t=e-o-s-o/2,n=s/2):(t=-o/2,n=e-2*o-s-s/2)}else t=(Math.random()-.5)*o,n=(Math.random()-.5)*s;u.set(t,n,ue+(Math.random()-.5)*.06).sub(l).applyAxisAngle(te,-ee),c.setXYZ(e,u.x,u.y,u.z)}c.needsUpdate=!0}function Ue(){let e=2*(y.position.z-g)*Math.tan(y.fov*Math.PI/360);return{w:e*y.aspect,h:e}}function We(e,t){let{w:n,h:r}=Ue();return{x:(e/100-.5)*n,y:(.5-t/100)*r}}let Ge=-99,Ke=new a,qe=new c,J=0,Y=0,X=new u;function Je(e){xe[Y].copy(e),Se[Y]=X.getElapsedTime(),Y=(Y+1)%_}x.current={syncPlanets(e){let t=new Set;for(let n of e){t.add(n.id);let e=q.get(n.id);if(!e){let t=he(String(n.id));e={...Ve(n.color,t),dissolve:0,target:0,morph:0,morphTarget:0,frozenRot:0,removing:!1,phase:t},e.dissolve=1,e.mat.uniforms.uDissolve.value=1,q.set(n.id,e)}e.xPct=n.x,e.yPct=n.y,e.mat.uniforms.uColor.value.set(n.color)}for(let[e,n]of q)!t.has(e)&&!n.removing&&(n.removing=!0,n.target=1)},dissolvePlanet(e){let t=q.get(e);t&&(t.frozenRot=t.points.rotation.y,He(t),t.morphTarget=1)},reformPlanet(e){let t=q.get(e);t&&(t.morphTarget=0)},pulseCenter(){let e=X.getElapsedTime();if(e-Ge<1.4)return;Ge=e;let t=new r(Math.random()-.5,Math.random()-.5,.6+Math.random()).normalize().multiplyScalar(h);Je(C.worldToLocal(t))}};function Ye(e){let t=b.domElement.getBoundingClientRect();qe.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),Ke.setFromCamera(qe,y);let n=Ke.intersectObject(F)[0];n&&Je(C.worldToLocal(n.point.clone()).normalize().multiplyScalar(h))}b.domElement.addEventListener(`pointerdown`,Ye);function Xe(){let t=e.clientWidth||1,n=e.clientHeight||1;y.aspect=t/n,y.updateProjectionMatrix(),b.setSize(t,n)}Xe();let Ze=new ResizeObserver(Xe);Ze.observe(e);let Z=0,Q=!0,Qe=0,$=0;function $e(){if(!Q)return;Z=requestAnimationFrame($e),J=X.getElapsedTime();let e=Math.min(J-Qe,.05);Qe=J;let n=t?0:J,r=t?1:1+.045*Math.sin(J*Math.PI*2/fe);S.uniforms.uNow.value=n,S.uniforms.uBreath.value=r,T.uniforms.uNow.value=n,T.uniforms.uBreath.value=r,z.uniforms.uNow.value=n,W&&(U.uniforms.uNow.value=n),D.uniforms.uNow.value=n,D.uniforms.uBreath.value=r,P.uniforms.uNow.value=n,t?(C.scale.setScalar(1),E.scale.setScalar(1),Ee.scale.setScalar(1),F.scale.setScalar(1),y.position.set(0,0,7),y.lookAt(0,0,0)):(C.rotation.y=J*.05,C.rotation.z=.14+.05*Math.sin(J*.1),E.rotation.y=J*.08,C.scale.setScalar(r),E.scale.setScalar(r),Ee.scale.setScalar(r),F.scale.setScalar(r),ze(J),y.position.x=Math.sin(J*.07)*.08,y.position.y=Math.cos(J*.09)*.05,y.lookAt(0,0,0));let i=!1;for(let[,e]of q)e.morphTarget>.5&&(i=!0);let a=2*e;$+=Math.max(-a,Math.min(a,+!!i-$));let o=_e.current,s=o?.62:0,c=e=>Math.max(e,s);S.uniforms.uLight.value=+!!o;let l=o?1:2;S.blending!==l&&(S.blending=l),w.visible=o,w.rotation.copy(C.rotation),w.scale.copy(C.scale),T.uniforms.uLight.value=+!!o,D.uniforms.uLight.value=+!!o,S.uniforms.uDim.value=$,T.uniforms.uDim.value=$,z.uniforms.uDim.value=c($),W&&(U.uniforms.uDim.value=c($)),D.uniforms.uDim.value=$,P.uniforms.uDim.value=c($);for(let e of G)e.active&&(e.line.material.opacity*=1-$*.85);for(let[r,i]of q){let a=(i.target>i.dissolve?1.6:.8)*e;i.dissolve+=Math.max(-a,Math.min(a,i.target-i.dissolve));let o=(i.morphTarget>i.morph?1.15:.95)*e;i.morph+=Math.max(-o,Math.min(o,i.morphTarget-i.morph)),i.mat.uniforms.uDissolve.value=i.dissolve,i.mat.uniforms.uMorph.value=i.morph,i.mat.uniforms.uNow.value=n,i.mat.uniforms.uDim.value=i.morphTarget>.5||i.morph>.01?0:$;let s=t?1:1+.06*Math.sin(J*1.1+i.phase*6.28);i.mat.uniforms.uPulse.value=s;let{x:c,y:l}=We(i.xPct,i.yPct);if(i.morphTarget>.5||i.morph>.01)i.points.position.set(c,l,g),i.points.rotation.y=i.frozenRot,i.points.scale.setScalar(1);else if(t)i.points.position.set(c,l,g),i.points.scale.setScalar(1);else{let e=Math.sin(J*.85+i.phase*6.28)*.07,t=Math.cos(J*.55+i.phase*4.2)*.04;i.points.position.set(c+t,l+e,g),i.points.rotation.y=J*.12+i.phase,i.points.scale.setScalar(s)}i.removing&&i.dissolve>.98&&(v.remove(i.points),i.mat.dispose(),q.delete(r))}b.render(v,y)}$e();let et=document.visibilityState===`visible`,tt=!0;function nt(){let e=et&&tt;e!==Q&&(e?(Q=!0,X.getElapsedTime(),$e()):(Q=!1,cancelAnimationFrame(Z)))}x.current.setRunning=e=>{tt=!!e,nt()};function rt(){et=document.visibilityState===`visible`,nt()}return document.addEventListener(`visibilitychange`,rt),()=>{Q=!1,cancelAnimationFrame(Z),document.removeEventListener(`visibilitychange`,rt),b.domElement.removeEventListener(`pointerdown`,Ye),Ze.disconnect();for(let[,e]of q)v.remove(e.points),e.mat.dispose();q.clear(),be.dispose(),S.dispose(),w.geometry.dispose(),Ce.dispose(),we.dispose(),T.dispose(),Te.dispose(),D.dispose(),N.dispose(),P.dispose(),R.dispose(),z.dispose(),W&&(H.dispose(),U.dispose()),K.dispose();for(let e of G)e.line.geometry.dispose(),e.line.material.dispose();F.geometry.dispose(),F.material.dispose(),b.domElement.removeEventListener(`webglcontextlost`,ve),b.domElement.removeEventListener(`webglcontextrestored`,ye),b.dispose(),ce(b),e.removeChild(b.domElement)}},[v]),(0,p.useEffect)(()=>{x.current.syncPlanets(e||[])},[e]),(0,m.jsx)(`div`,{ref:n,"aria-hidden":`true`,style:{position:`absolute`,inset:0,overflow:`hidden`,background:y?`linear-gradient(180deg,
