import{a as e,n as t,t as n}from"./jsx-runtime-DIAExeAg.js";import{$ as r,Bt as i,Ct as a,I as o,L as s,Mt as c,Q as l,dt as ee,ft as u,h as te,l as d,m as ne,mt as f,t as re,u as p,wt as m,yt as ie,zt as ae}from"./three.module-MEH2mPKQ.js";var h=e(t()),g=n(),_=1.35,oe=.36,v=.8,se=3.2,ce=3.2,y=6,le=3.6;function ue(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random()*2-1,o=Math.random()*Math.PI*2,s=Math.sqrt(1-e*e),c=t*(.9+.1*Math.random());n[a*3]=s*Math.cos(o)*c,n[a*3+1]=e*c,n[a*3+2]=s*Math.sin(o)*c,r[a]=Math.random(),i[a]=.6+Math.random()}let a=new p;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function de(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let o=a/e*Math.PI*2+Math.random()*.04,s=(Math.random()-.5)*.22,c=t*(.96+Math.random()*.1);n[a*3]=Math.cos(o)*c,n[a*3+1]=Math.sin(o)*c*.42+s*c,n[a*3+2]=Math.sin(o)*c*.18,r[a]=Math.random(),i[a]=.7+Math.random()*1.2}let a=new p;return a.setAttribute(`position`,new d(n,3)),a.setAttribute(`aRand`,new d(r,1)),a.setAttribute(`aSize`,new d(i,1)),a}function fe(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return Math.abs(t)%1e3/1e3}var b=(0,h.forwardRef)(function({planets:e},t){let n=(0,h.useRef)(null),b=(0,h.useRef)({syncPlanets:()=>{},dissolvePlanet:()=>{},reformPlanet:()=>{},pulseCenter:()=>{}});return(0,h.useImperativeHandle)(t,()=>({dissolvePlanet:e=>b.current.dissolvePlanet(e),reformPlanet:e=>b.current.reformPlanet(e),pulseCenter:()=>b.current.pulseCenter()}),[]),(0,h.useEffect)(()=>{let e=n.current;if(!e)return;let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,h=window.matchMedia(`(pointer: fine)`).matches,g=h?1:1.45,x=new a,S=new ee(55,1,.1,200);S.position.set(0,0,7);let C=new re({antialias:!0});C.setPixelRatio(Math.min(window.devicePixelRatio||1,h?1.5:1.35)),C.setClearColor(0,1),C.domElement.style.display=`block`,e.appendChild(C.domElement);let pe=ue(h?22e3:16e3,_),me=[],he=[];for(let e=0;e<y;e++)me.push(new i),he.push(-99);let w=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1},uTouches:{value:me},uStarts:{value:he}},vertexShader:`
      ...
      `}),T=new f(pe,w);x.add(T);let ge=de(h?220:480,_*1.38),E=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        uniform float uBoost;
      ...
      `}),D=new f(ge,E);x.add(D);let _e=new u(_*(h?3.6:5.2),_*(h?3.6:5.2)),O=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g},uBreath:{value:1}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),ve=new l(_e,O);x.add(ve);let k=[{r:_*1.55,speed:.5,tiltX:.55,tiltZ:.3,col:[1,.85,.58]},{r:_*1.85,speed:-.36,tiltX:-.72,tiltZ:.18,col:[.62,.85,1]},{r:_*2.15,speed:.27,tiltX:.24,tiltZ:-.6,col:[.85,.7,1]}],A=h?48:60,j=k.length*A,ye=new Float32Array(j*3),be=new Float32Array(j),M=new Float32Array(j*4),xe=new Float32Array(j*2),N=new Float32Array(j*3);for(let e=0;e<k.length;e++){let t=k[e],n=e/k.length*Math.PI*2;for(let r=0;r<A;r++){let i=e*A+r;be[i]=r/(A-1),M[i*4]=t.r,M[i*4+1]=t.speed,M[i*4+2]=n,M[i*4+3]=n*2.7,xe[i*2]=t.tiltX,xe[i*2+1]=t.tiltZ,N[i*3]=t.col[0],N[i*3+1]=t.col[1],N[i*3+2]=t.col[2]}}let P=new p;P.setAttribute(`position`,new d(ye,3)),P.setAttribute(`aT`,new d(be,1)),P.setAttribute(`aOrb`,new d(M,4)),P.setAttribute(`aTilt`,new d(xe,2)),P.setAttribute(`aCol`,new d(N,3));let F=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:g}},vertexShader:`
        attribute float aT;
        attribute vec4 aOrb;
      ...
      `}),Se=new f(P,F);Se.frustumCulled=!1,Se.visible=!t,x.add(Se);let I=new l(new c(_*1.12,16,16),new r({visible:!1}));x.add(I);let L=h?700:900,R=new Float32Array(L*3),Ce=new Float32Array(L),we=new Float32Array(L),Te=new Float32Array(L),Ee=new Float32Array(L);for(let e=0;e<L;e++){let t=Math.random()*2-1,n=Math.random()*Math.PI*2,r=Math.sqrt(1-t*t),i=25+Math.random()*45;R[e*3]=r*Math.cos(n)*i,R[e*3+1]=t*i,R[e*3+2]=r*Math.sin(n)*i,Ce[e]=Math.random()*Math.PI*2,we[e]=.2+Math.random()*1.8,Te[e]=Math.random()<.35?1:.25+Math.random()*.4,Ee[e]=.5+Math.random()*1.3}let z=new p;z.setAttribute(`position`,new d(R,3)),z.setAttribute(`aPhase`,new d(Ce,1)),z.setAttribute(`aSpeed`,new d(we,1)),z.setAttribute(`aDepth`,new d(Te,1)),z.setAttribute(`aSize`,new d(Ee,1));let B=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
      ...
      `});x.add(new f(z,B));let V=h?0:350,H=new Float32Array(V*3),De=new Float32Array(V),Oe=new Float32Array(V);for(let e=0;e<V;e++)H[e*3]=(Math.random()-.5)*28,H[e*3+1]=(Math.random()-.5)*22,H[e*3+2]=(Math.random()-.5)*18-2,De[e]=Math.random(),Oe[e]=1.2+Math.random()*2.8;let U=new p;U.setAttribute(`position`,new d(H,3)),U.setAttribute(`aRand`,new d(De,1)),U.setAttribute(`aSize`,new d(Oe,1));let W=new m({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        varying float vAlpha;
