import{a as e,n as t,t as n}from"./jsx-runtime-DIAExeAg.js";import{F as r,J as i,Mt as a,P as o,Y as s,_t as c,at as l,c as u,ct as d,jt as ee,l as f,m as te,ot as ne,p as re,pt as ie,t as ae,vt as p,wt as oe}from"./three.module-bqQyl-Ly.js";import{r as se}from"./c3dViewport-D3K1ZAxX.js";var m=e(t()),h=n(),g={css:`var(--universe-dusk)`,bodyTop:[.128,.12,.104],bodyBot:[.196,.17,.134],rim:[.62,.44,.24],halo:[.58,.46,.32],star:[.72,.68,.6],bgDim:.92},_=1.35,ce=.36,v=.8,le=3.2,ue=3.2,y=6,de=3.6;function fe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random()*2-1,o=Math.random()*Math.PI*2,s=Math.sqrt(1-e*e),c=t*(.9+.1*Math.random());n[a*3]=s*Math.cos(o)*c,n[a*3+1]=e*c,n[a*3+2]=s*Math.sin(o)*c,r[a]=Math.random(),i[a]=.6+Math.random()}let a=new f;return a.setAttribute(`position`,new u(n,3)),a.setAttribute(`aRand`,new u(r,1)),a.setAttribute(`aSize`,new u(i,1)),a}function pe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let o=a/e*Math.PI*2+Math.random()*.04,s=(Math.random()-.5)*.22,c=t*(.96+Math.random()*.1);n[a*3]=Math.cos(o)*c,n[a*3+1]=Math.sin(o)*c*.42+s*c,n[a*3+2]=Math.sin(o)*c*.18,r[a]=Math.random(),i[a]=.7+Math.random()*1.2}let a=new f;return a.setAttribute(`position`,new u(n,3)),a.setAttribute(`aRand`,new u(r,1)),a.setAttribute(`aSize`,new u(i,1)),a}function me(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return Math.abs(t)%1e3/1e3}var b=(0,m.forwardRef)(function({planets:e},t){let n=(0,m.useRef)(null),[b,he]=(0,m.useState)(0),ge=(0,m.useRef)(!1),[x,S]=(0,m.useState)(!1);(0,m.useEffect)(()=>{let e=()=>{let e=document.documentElement.dataset.homeTheme===`light`;ge.current=e,S(e)};e();let t=new MutationObserver(e);return t.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-home-theme`]}),()=>t.disconnect()},[]);let C=(0,m.useRef)({syncPlanets:()=>{},dissolvePlanet:()=>{},reformPlanet:()=>{},pulseCenter:()=>{},setRunning:()=>{}}),_e=(0,m.useRef)(!0);return(0,m.useImperativeHandle)(t,()=>({dissolvePlanet:e=>C.current.dissolvePlanet(e),reformPlanet:e=>C.current.reformPlanet(e),pulseCenter:()=>C.current.pulseCenter(),setRunning:e=>{_e.current=!!e,C.current.setRunning(!!e)}}),[]),(0,m.useEffect)(()=>{let e=n.current;if(!e)return;let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,m=window.matchMedia(`(pointer: fine)`).matches,h=m?1:1.45,b=new c,x=new l(55,1,.1,200);x.position.set(0,0,7);let S=new ae({antialias:!0,alpha:!0}),w=0,ve=document.visibilityState===`visible`,ye=_e.current,be=!1,T=ve&&ye,xe=e=>{e.preventDefault(),be=!0,T=!1,cancelAnimationFrame(w),w=0},Se=()=>{he(e=>e+1)};S.domElement.addEventListener(`webglcontextlost`,xe,!1),S.domElement.addEventListener(`webglcontextrestored`,Se,!1),S.setPixelRatio(Math.min(window.devicePixelRatio||1,m?1.5:1.35)),S.setClearColor(0,0),S.domElement.style.display=`block`,e.appendChild(S.domElement);let Ce=fe(m?22e3:16e3,_),we=[],Te=[];for(let e=0;e<y;e++)we.push(new a),Te.push(-99);let E=new p({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0},uBodyTop:{value:new a(...g.bodyTop)},uBodyBot:{value:new a(...g.bodyBot)},uRim:{value:new a(...g.rim)},uTouches:{value:we},uStarts:{value:Te}},vertexShader:`
      ...
      `}),D=new d(Ce,E);b.add(D);let Ee=new p({uniforms:{uNow:{value:0},uTop:{value:new a(...g.bodyTop)},uBot:{value:new a(...g.bodyBot)},uRim:{value:new a(...g.rim)}},vertexShader:`
        varying vec3 vNv;
        varying vec3 vObj;
        varying vec3 vView;
        void main() {
      ...
      `,transparent:!0,depthWrite:!1}),O=new i(new oe(_*.98,64,48),Ee);O.visible=!1,O.renderOrder=-1,b.add(O);let De=pe(m?220:480,_*1.38),k=new p({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0},uWarm:{value:new a(...g.halo)}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        uniform float uBoost;
      ...
      `}),A=new d(De,k);b.add(A);let Oe=new ne(_*(m?3.6:5.2),_*(m?3.6:5.2)),j=new p({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `});b.add(new d(H,U));let W=m?0:350,G=new Float32Array(W*3),Re=new Float32Array(W),ze=new Float32Array(W);for(let e=0;e<W;e++)G[e*3]=(Math.random()-.5)*28,G[e*3+1]=(Math.random()-.5)*22,G[e*3+2]=(Math.random()-.5)*18-2,Re[e]=Math.random(),ze[e]=1.2+Math.random()*2.8;let K=new f;K.setAttribute(`position`,new u(G,3)),K.setAttribute(`aRand`,new u(Re,1)),K.setAttribute(`aSize`,new u(ze,1));let q=new p({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        varying float vAlpha;
