import{a as e,n as t,t as n}from"./jsx-runtime-DIAExeAg.js";import{r}from"./c3dViewport-D3K1ZAxX.js";import{B as i,G as a,I as o,L as s,N as c,O as l,T as ee,W as u,a as d,b as te,c as ne,i as f,j as p,k as re,l as ie,t as ae,w as oe,y as se}from"./three.module-htE8Q1do.js";var m=e(t()),h=n(),g={css:`var(--universe-dusk)`,bodyTop:[.128,.12,.104],bodyBot:[.196,.17,.134],rim:[.62,.44,.24],halo:[.58,.46,.32],star:[.72,.68,.6],bgDim:.92},_=1.35,ce=.36,v=.8,le=3.2,ue=3.2,y=6,de=3.6;function fe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let e=Math.random()*2-1,o=Math.random()*Math.PI*2,s=Math.sqrt(1-e*e),c=t*(.9+.1*Math.random());n[a*3]=s*Math.cos(o)*c,n[a*3+1]=e*c,n[a*3+2]=s*Math.sin(o)*c,r[a]=Math.random(),i[a]=.6+Math.random()}let a=new d;return a.setAttribute(`position`,new f(n,3)),a.setAttribute(`aRand`,new f(r,1)),a.setAttribute(`aSize`,new f(i,1)),a}function pe(e,t){let n=new Float32Array(e*3),r=new Float32Array(e),i=new Float32Array(e);for(let a=0;a<e;a++){let o=a/e*Math.PI*2+Math.random()*.04,s=(Math.random()-.5)*.22,c=t*(.96+Math.random()*.1);n[a*3]=Math.cos(o)*c,n[a*3+1]=Math.sin(o)*c*.42+s*c,n[a*3+2]=Math.sin(o)*c*.18,r[a]=Math.random(),i[a]=.7+Math.random()*1.2}let a=new d;return a.setAttribute(`position`,new f(n,3)),a.setAttribute(`aRand`,new f(r,1)),a.setAttribute(`aSize`,new f(i,1)),a}function me(e){let t=0;for(let n=0;n<e.length;n++)t=t*31+e.charCodeAt(n)|0;return Math.abs(t)%1e3/1e3}var b=(0,m.forwardRef)(function({planets:e},t){let n=(0,m.useRef)(null),[b,he]=(0,m.useState)(0),ge=(0,m.useRef)(!1),[x,S]=(0,m.useState)(!1);(0,m.useEffect)(()=>{let e=()=>{let e=document.documentElement.dataset.homeTheme===`light`;ge.current=e,S(e)};e();let t=new MutationObserver(e);return t.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-home-theme`]}),()=>t.disconnect()},[]);let C=(0,m.useRef)({syncPlanets:()=>{},dissolvePlanet:()=>{},reformPlanet:()=>{},pulseCenter:()=>{},setRunning:()=>{}}),_e=(0,m.useRef)(!0);return(0,m.useImperativeHandle)(t,()=>({dissolvePlanet:e=>C.current.dissolvePlanet(e),reformPlanet:e=>C.current.reformPlanet(e),pulseCenter:()=>C.current.pulseCenter(),setRunning:e=>{_e.current=!!e,C.current.setRunning(!!e)}}),[]),(0,m.useEffect)(()=>{let e=n.current;if(!e)return;let t=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,m=window.matchMedia(`(pointer: fine)`).matches,h=m?1:1.45,b=new o,x=new l(55,1,.1,200);x.position.set(0,0,7);let S=new ae({antialias:!0,alpha:!0}),w=0,ve=document.visibilityState===`visible`,ye=_e.current,be=!1,T=ve&&ye,xe=e=>{e.preventDefault(),be=!0,T=!1,cancelAnimationFrame(w),w=0},Se=()=>{he(e=>e+1)};S.domElement.addEventListener(`webglcontextlost`,xe,!1),S.domElement.addEventListener(`webglcontextrestored`,Se,!1),S.setPixelRatio(Math.min(window.devicePixelRatio||1,m?1.5:1.35)),S.setClearColor(0,0),S.domElement.style.display=`block`,e.appendChild(S.domElement);let Ce=fe(m?22e3:16e3,_),we=[],Te=[];for(let e=0;e<y;e++)we.push(new a),Te.push(-99);let E=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0},uBodyTop:{value:new a(...g.bodyTop)},uBodyBot:{value:new a(...g.bodyBot)},uRim:{value:new a(...g.rim)},uTouches:{value:we},uStarts:{value:Te}},vertexShader:`
      ...
      `}),D=new p(Ce,E);b.add(D);let Ee=new s({uniforms:{uNow:{value:0},uTop:{value:new a(...g.bodyTop)},uBot:{value:new a(...g.bodyBot)},uRim:{value:new a(...g.rim)}},vertexShader:`
        varying vec3 vNv;
        varying vec3 vObj;
        varying vec3 vView;
        void main() {
      ...
      `,transparent:!0,depthWrite:!1}),O=new oe(new i(_*.98,64,48),Ee);O.visible=!1,O.renderOrder=-1,b.add(O);let De=pe(m?220:480,_*1.38),k=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0},uWarm:{value:new a(...g.halo)}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        uniform float uBoost;
      ...
      `}),A=new p(De,k);b.add(A);let Oe=new re(_*(m?3.6:5.2),_*(m?3.6:5.2)),j=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h},uBreath:{value:1},uLight:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `}),ke=new oe(Oe,j);b.add(ke);let M=[{r:_*1.55,speed:.5,tiltX:.55,tiltZ:.3,col:[1,.85,.58]},{r:_*1.85,speed:-.36,tiltX:-.72,tiltZ:.18,col:[.62,.85,1]},{r:_*2.15,speed:.27,tiltX:.24,tiltZ:-.6,col:[.85,.7,1]}],N=m?48:60,P=M.length*N,Ae=new Float32Array(P*3),je=new Float32Array(P),F=new Float32Array(P*4),Me=new Float32Array(P*2),I=new Float32Array(P*3);for(let e=0;e<M.length;e++){let t=M[e],n=e/M.length*Math.PI*2;for(let r=0;r<N;r++){let i=e*N+r;je[i]=r/(N-1),F[i*4]=t.r,F[i*4+1]=t.speed,F[i*4+2]=n,F[i*4+3]=n*2.7,Me[i*2]=t.tiltX,Me[i*2+1]=t.tiltZ,I[i*3]=t.col[0],I[i*3+1]=t.col[1],I[i*3+2]=t.col[2]}}let L=new d;L.setAttribute(`position`,new f(Ae,3)),L.setAttribute(`aT`,new f(je,1)),L.setAttribute(`aOrb`,new f(F,4)),L.setAttribute(`aTilt`,new f(Me,2)),L.setAttribute(`aCol`,new f(I,3));let R=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uBoost:{value:h}},vertexShader:`
        attribute float aT;
        attribute vec4 aOrb;
      ...
      `}),Ne=new p(L,R);Ne.frustumCulled=!1,Ne.visible=!t,b.add(Ne);let z=new oe(new i(_*1.12,16,16),new ee({visible:!1}));b.add(z);let B=m?700:900,V=new Float32Array(B*3),Pe=new Float32Array(B),Fe=new Float32Array(B),Ie=new Float32Array(B),Le=new Float32Array(B);for(let e=0;e<B;e++){let t=Math.random()*2-1,n=Math.random()*Math.PI*2,r=Math.sqrt(1-t*t),i=25+Math.random()*45;V[e*3]=r*Math.cos(n)*i,V[e*3+1]=t*i,V[e*3+2]=r*Math.sin(n)*i,Pe[e]=Math.random()*Math.PI*2,Fe[e]=.2+Math.random()*1.8,Ie[e]=Math.random()<.35?1:.25+Math.random()*.4,Le[e]=.5+Math.random()*1.3}let H=new d;H.setAttribute(`position`,new f(V,3)),H.setAttribute(`aPhase`,new f(Pe,1)),H.setAttribute(`aSpeed`,new f(Fe,1)),H.setAttribute(`aDepth`,new f(Ie,1)),H.setAttribute(`aSize`,new f(Le,1));let U=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0},uCol:{value:new a(.85,.82,.72)}},vertexShader:`
      ...
      `});b.add(new p(H,U));let W=m?0:350,G=new Float32Array(W*3),Re=new Float32Array(W),ze=new Float32Array(W);for(let e=0;e<W;e++)G[e*3]=(Math.random()-.5)*28,G[e*3+1]=(Math.random()-.5)*22,G[e*3+2]=(Math.random()-.5)*18-2,Re[e]=Math.random(),ze[e]=1.2+Math.random()*2.8;let K=new d;K.setAttribute(`position`,new f(G,3)),K.setAttribute(`aRand`,new f(Re,1)),K.setAttribute(`aSize`,new f(ze,1));let q=new s({transparent:!0,depthWrite:!1,blending:2,uniforms:{uNow:{value:0},uDim:{value:0}},vertexShader:`
        attribute float aRand;
        attribute float aSize;
        uniform float uNow;
        varying float vAlpha;
    ...
    `}),r=new p(X,n);return b.add(r),{points:r,mat:n,phase:t}}function Ge(t){let n=e.clientWidth||1,r=e.clientHeight||1,i=2*(x.position.z-le)*Math.tan(x.fov*Math.PI/360)/r,o=Math.min(.9*n,560)*i,s=Math.min(.68*r,620)*i,c=X.getAttribute(`aPaper`),l=t.points.position,ee=t.frozenRot,u=new a,d=new a(0,1,0);for(let e=0;e<Ue;e++){let t,n;if(e%3==0){let e=Math.random()*2*(o+s);e<o?(t=e-o/2,n=-s/2):e<o+s?(t=o/2,n=e-o-s/2):e<2*o+s?(t=e-o-s-o/2,n=s/2):(t=-o/2,n=e-2*o-s-s/2)}else t=(Math.random()-.5)*o,n=(Math.random()-.5)*s;u.set(t,n,le+(Math.random()-.5)*.06).sub(l).applyAxisAngle(d,-ee),c.setXYZ(e,u.x,u.y,u.z)}c.needsUpdate=!0}function Ke(){let e=2*(x.position.z-v)*Math.tan(x.fov*Math.PI/360);return{w:e*x.aspect,h:e}}function qe(e,t){let{w:n,h:r}=Ke();return{x:(e/100-.5)*n,y:(.5-t/100)*r}}let Je=-99,Ye=new c,Xe=new u,Q=0,Ze=0,Qe=new ne,$e=0;function et(e){we[Ze].copy(e),Te[Ze]=$e,Ze=(Ze+1)%y}C.current={syncPlanets(e){let t=new Set;for(let n of e){t.add(n.id);let e=Z.get(n.id);if(!e){let t=me(String(n.id));e={...We(n.color,t),dissolve:0,target:0,morph:0,morphTarget:0,frozenRot:0,removing:!1,phase:t},e.dissolve=1,e.mat.uniforms.uDissolve.value=1,Z.set(n.id,e)}e.xPct=n.x,e.yPct=n.y,e.mat.uniforms.uColor.value.set(n.color)}for(let[e,n]of Z)!t.has(e)&&!n.removing&&(n.removing=!0,n.target=1)},dissolvePlanet(e){let t=Z.get(e);t&&(t.frozenRot=t.points.rotation.y,Ge(t),t.morphTarget=1)},reformPlanet(e){let t=Z.get(e);t&&(t.morphTarget=0)},pulseCenter(){let e=$e;if(e-Je<1.4)return;Je=e;let t=new a(Math.random()-.5,Math.random()-.5,.6+Math.random()).normalize().multiplyScalar(_);et(D.worldToLocal(t))}};function tt(e){let t=S.domElement.getBoundingClientRect();Xe.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),Ye.setFromCamera(Xe,x);let n=Ye.intersectObject(z)[0];n&&et(D.worldToLocal(n.point.clone()).normalize().multiplyScalar(_))}S.domElement.addEventListener(`pointerdown`,tt);function nt(){let t=e.clientWidth,n=e.clientHeight;t===0||n===0||(x.aspect=t/n,x.updateProjectionMatrix(),S.setSize(t,n))}nt();let rt=new ResizeObserver(nt);rt.observe(e);let $=0;function it(){if(!T)return;w=requestAnimationFrame(it);let e=Math.min(Qe.getDelta(),.05);$e+=e,Q=$e;let n=t?0:Q,r=t?1:1+.045*Math.sin(Q*Math.PI*2/de);E.uniforms.uNow.value=n,E.uniforms.uBreath.value=r,k.uniforms.uNow.value=n,k.uniforms.uBreath.value=r,U.uniforms.uNow.value=n,J&&(q.uniforms.uNow.value=n),j.uniforms.uNow.value=n,j.uniforms.uBreath.value=r,R.uniforms.uNow.value=n,t?(D.scale.setScalar(1),A.scale.setScalar(1),ke.scale.setScalar(1),z.scale.setScalar(1),x.position.set(0,0,7),x.lookAt(0,0,0)):(D.rotation.y=Q*.05,D.rotation.z=.14+.05*Math.sin(Q*.1),A.rotation.y=Q*.08,D.scale.setScalar(r),A.scale.setScalar(r),ke.scale.setScalar(r),z.scale.setScalar(r),He(Q),x.position.x=Math.sin(Q*.07)*.08,x.position.y=Math.cos(Q*.09)*.05,x.lookAt(0,0,0));let i=!1;for(let[,e]of Z)e.morphTarget>.5&&(i=!0);let a=2*e;$+=Math.max(-a,Math.min(a,+!!i-$));let o=ge.current,s=o?g.bgDim:0;U.uniforms.uCol.value.set(...o?g.star:[.85,.82,.72]);let c=e=>Math.max(e,s);E.uniforms.uLight.value=+!!o;let l=o?1:2;E.blending!==l&&(E.blending=l),O.visible=o,O.rotation.copy(D.rotation),O.scale.copy(D.scale),k.uniforms.uLight.value=+!!o,j.uniforms.uLight.value=+!!o,E.uniforms.uDim.value=$,k.uniforms.uDim.value=$,U.uniforms.uDim.value=c($),J&&(q.uniforms.uDim.value=c($)),j.uniforms.uDim.value=$,R.uniforms.uDim.value=c($);for(let e of Y)e.active&&(e.line.material.opacity*=1-$*.85);for(let[r,i]of Z){let a=(i.target>i.dissolve?1.6:.8)*e;i.dissolve+=Math.max(-a,Math.min(a,i.target-i.dissolve));let o=(i.morphTarget>i.morph?1.15:.95)*e;i.morph+=Math.max(-o,Math.min(o,i.morphTarget-i.morph)),i.mat.uniforms.uDissolve.value=i.dissolve,i.mat.uniforms.uMorph.value=i.morph,i.mat.uniforms.uNow.value=n,i.mat.uniforms.uDim.value=i.morphTarget>.5||i.morph>.01?0:$;let s=t?1:1+.06*Math.sin(Q*1.1+i.phase*6.28);i.mat.uniforms.uPulse.value=s;let{x:c,y:l}=qe(i.xPct,i.yPct);if(i.morphTarget>.5||i.morph>.01)i.points.position.set(c,l,v),i.points.rotation.y=i.frozenRot,i.points.scale.setScalar(1);else if(t)i.points.position.set(c,l,v),i.points.scale.setScalar(1);else{let e=Math.sin(Q*.85+i.phase*6.28)*.07,t=Math.cos(Q*.55+i.phase*4.2)*.04;i.points.position.set(c+t,l+e,v),i.points.rotation.y=Q*.12+i.phase,i.points.scale.setScalar(s)}i.removing&&i.dissolve>.98&&(b.remove(i.points),i.mat.dispose(),Z.delete(r))}S.render(b,x)}let at=T;T=!0,it(),at||(T=!1,cancelAnimationFrame(w));function ot(){let e=ve&&ye&&!be;e!==T&&(e?(T=!0,Qe.getDelta(),it()):(T=!1,cancelAnimationFrame(w)))}C.current.setRunning=e=>{ye=!!e,_e.current=!!e,ot()};function st(){ve=document.visibilityState===`visible`,ot()}return document.addEventListener(`visibilitychange`,st),()=>{T=!1,cancelAnimationFrame(w),document.removeEventListener(`visibilitychange`,st),S.domElement.removeEventListener(`pointerdown`,tt),rt.disconnect();for(let[,e]of Z)b.remove(e.points),e.mat.dispose();Z.clear(),Ce.dispose(),E.dispose(),O.geometry.dispose(),Ee.dispose(),De.dispose(),k.dispose(),Oe.dispose(),j.dispose(),L.dispose(),R.dispose(),H.dispose(),U.dispose(),J&&(K.dispose(),q.dispose()),X.dispose();for(let e of Y)e.line.geometry.dispose(),e.line.material.dispose();z.geometry.dispose(),z.material.dispose(),S.domElement.removeEventListener(`webglcontextlost`,xe),S.domElement.removeEventListener(`webglcontextrestored`,Se),S.dispose(),r(S),e.removeChild(S.domElement)}},[b]),(0,m.useEffect)(()=>{C.current.syncPlanets(e||[])},[e]),(0,h.jsx)(`div`,{ref:n,"aria-hidden":`true`,style:{position:`absolute`,inset:0,overflow:`hidden`,background:x?g.css:`var(--universe-dusk)`}})});export{b as default};