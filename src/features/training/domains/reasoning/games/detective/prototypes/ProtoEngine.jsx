      ...
      {phase === 'verdict' && verdict && (
        ...
        <div style={S.body}>
          <div style={{ ...S.verdictCard, animation: verdict.win ? 'dt-slide 0.3s ease-out' : 'dt-shake 0.4s ease-out' }}>
            ...
            <div style={{ ...S.verdictTitle, color: verdict.win ? 'var(--success)' : 'var(--danger)' }}>
...
const S = {
  root: {
    ...
    background: 'var(--play-surface)', color: 'var(--play-ink)',
    fontFamily: "'Outfit', system-ui, sans-serif",
  },
  rootFile: { background: 'var(--surface)' },
  ...
  tab: {
    flex: '1 0 auto', minWidth: 72, padding: '8px 4px', borderRadius: '12px 12px 0 0', border: '1.5px solid var(--line)',
    borderBottom: 'none', background: 'var(--surface-raised)', color: 'var(--ink-dim)', fontWeight: 800, fontSize: 11,
  ...
  transcriptHead: {
    ...
    borderBottom: '2px solid var(--line)', paddingBottom: 6, marginBottom: 4,
  },
  transcriptBlock: { borderInlineStart: '3px solid var(--line)', paddingInlineStart: 8 },
  ...
  accuseBtn: {
    width: '100%', padding: '14px 16px', borderRadius: 14, border: '2px solid var(--ink-outline)',
    background: 'var(--danger)', color: '#fff', fontWeight: 900, fontSize: 15, cursor: 'pointer', boxShadow: '3px 3px 0 var(--ink-outline)',
  },
  fileCard: {
    width: '100%', background: 'var(--surface-raised)', border: '2px solid var(--line)', borderRadius: 16,
    padding: '14px 16px 18px', display: 'flex', flexDirection: 'column', gap: 8,
    boxShadow: '4px 4px 0 rgba(26,18,8,0.18)', animation: 'dt-slide 0.35s ease-out', color: 'var(--ink)',
  },
  ...
  portraitSm: { width: 36, height: 36, borderRadius: 999, background: 'var(--surface-raised)', border: '2.5px solid var(--line)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, flexShrink: 0 },
  suspectMeta: { display: 'flex', flexDirection: 'column', gap: 2, minWidth: 0 },
  suspectName: { fontWeight: 900, fontSize: 13.5, color: 'var(--ink)' },
  suspectDesc: { fontWeight: 700, fontSize: 12, color: 'var(--ink-dim)', lineHeight: 1.4 },
  noteCardBtn: {
    display: 'flex', gap: 10, padding: '10px 12px', borderRadius: 12, border: '1.5px solid var(--line)',
    background: 'var(--surface-raised)', width: '100%', textAlign: 'start', cursor: 'pointer', color: 'inherit', font: 'inherit', marginBottom: 6,
  },
  ...
  sheetCard: {
    ...
    padding: '18px 18px 16px', display: 'flex', flexDirection: 'column', gap: 10, color: 'var(--ink)',
  ...
  partialSub: { margin: 0, fontWeight: 700, fontSize: 14, color: 'var(--ink-dim)', textAlign: 'center' },
  truth: { display: 'flex', gap: 10, alignItems: 'center', fontWeight: 900, fontSize: 15, color: 'var(--ink)' },
