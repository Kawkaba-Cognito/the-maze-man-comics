...
const UI = {
  en: {
    ...STR_COMMON.en,
    hub: 'Reasoning', title: 'Colour Sort',
    ...
    moves: 'Moves', par: 'Par', lives: 'Skips', undo: '↶ Undo', reset: '↺ Reset', skip: '⤼ Skip',
    ...
    chalBullet1: 'Same board for everyone — fewest moves wins', chalBullet2: 'Tap Start only when the device is with this player',
    chalMeta: (lbl, c) => `${lbl} · ${c} colours`,
    chalResDetail: (m, solv) => (solv ? `${m} moves` : 'unsolved'),
  },
  ar: {
    ...STR_COMMON.ar,
    hub: 'تفكير', title: 'فرز الألوان',
    ...
    moves: 'الحركات', par: 'المعيار', lives: 'تخطّيات', undo: '↶ تراجع', reset: '↺ إعادة', skip: '⤼ تخطٍّ',
    over: 'انتهت المحاولة', best: (n) => `الأفضل: ${n}`, again: 'العب مجددًا',
    levelPass: 'حُلّت!', nextLv: 'المرحلة التالية',
    perfect: 'إتقان!', good: 'مرتّب', tryAgain: 'حُلّت',
    chalTitle: 'مرّر والعب', chalSub: 'الجميع يفرز نفس اللوح · مرّر الجهاز · الأقل حركات يفوز',
    chalBullet1: 'نفس اللوح للجميع — الأقل حركات يفوز', chalBullet2: 'اضغط ابدأ فقط عندما يكون الجهاز مع هذا اللاعب',
    chalMeta: (lbl, c) => `${lbl} · ${c} ألوان`,
    chalResDetail: (m, solv) => (solv ? `${m} حركة` : 'لم يُحل'),
  },
};
