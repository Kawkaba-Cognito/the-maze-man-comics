...
const reasoning = {
  ...
  subs: [
    ...
    },
    {
      ...
      name: 'Detective',
      nameAr: 'المحقّق',
      blurb: 'Search the scene, interrogate suspects, and prove who did it — you are Detective Kawkab.',
      blurbAr: 'فتّش مسرح الجريمة، واستجوب المشتبه بهم، وأثبت من الفاعل — أنت المحقّق كوكب.',
      gameCount: 1,
      progress: 0,
      gameKey: 'detective',
      tier: 'free',
