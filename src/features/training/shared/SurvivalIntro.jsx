 ...
 */
export default function SurvivalIntro({ isAr, playSfx, onReady, onBack, title, body, badge }) {
    ...
    <div className="ct-fq-training-shell ct-fq-training-shell--hub-light" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="ct-fq-screen ct-fq-training-screen ct-survival-intro">
        ...
        <div className="ct-survival-intro-body">
          <div className="ct-survival-intro-badge" aria-hidden="true">
            {badge ? <img src={badge} alt="" className="ct-survival-intro-badge-img" /> : '♾️'}
          </div>
