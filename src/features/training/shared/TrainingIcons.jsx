...
const I = ({ children, size = 28, c = 'var(--accent)', sw = 2 }) => (
...
export const IconFlame = (p) => <I {...p}><path d="M16 4c2 4 6 6 6 12a6 6 0 01-12 0c0-3 1-4 2-5 0 2 1 3 2 3 0-4-2-6 2-10z" fill={p.c || 'var(--accent)'} fillOpacity="0.25"/></I>;
export const IconPlay = (p) => <I {...p} sw={0}><path d="M10 6l16 10L10 26z" fill={p.c || 'var(--accent)'}/></I>;
export const IconStar = (p) => <I {...p}><path d="M16 6l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z" fill={p.c || 'var(--accent)'} fillOpacity="0.2"/></I>;
