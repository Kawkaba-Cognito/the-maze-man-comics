...
export const SP={
  easy:[
    ...
    ['cross','pentagon','ovalSq','hexTall','arrowL','lightning'],
    ['pentagon','roundsq','hexagon','arrowR','lightning','parallelR','tallRect'],
    ['ovalSq','hexTall','arrowL','lightning','wideRect','tallRect','shield'],
    ['hexagon','arrowR','lightning','parallelR','tallRect','shield','trapezoid'],
    ['arrowL','lightning','wideRect','tallRect','shield','trapezoid','triFlat','semicircle'],
    ['lightning','parallelR','tallRect','shield','trapezoid','triangle','fatOval'],
    ...
    ['shield','trapezoid','triangle','bigSemi','diamond','square','star','tinyMoon','heart'],
    ...
    ['rhombus','square','star','tinyMoon','heart','cross','pentagon','ovalSq','hexTall','arrowL','lightning'],
  ],
  medium:[
    ...
    ['pentagon','ovalSq','hexTall','arrowL','lightning'],
    ['roundsq','hexagon','arrowR','lightning','parallelR'],
    ['hexTall','arrowL','lightning','wideRect','tallRect'],
    ['arrowR','lightning','parallelR','tallRect','shield'],
    ['lightning','wideRect','tallRect','shield','trapezoid'],
    ['parallelR','tallRect','shield','trapezoid','triangle'],
    ['tallRect','shield','trapezoid','triR','bigSemi'],
  ...
  hard:[
    ...
    ['ovalSq','hexTall','arrowL','lightning'],
    ['hexagon','arrowR','lightning','parallelR'],
    ['arrowL','lightning','wideRect','tallRect'],
    ['lightning','parallelR','tallRect','shield'],
    ...
    ['heart','cross','pentagon','ovalSq','hexTall','arrowL','lightning','wideRect'],
    ['cross','pentagon','roundsq','hexagon','arrowR','lightning','parallelR','tallRect'],
    ['pentagon','ovalSq','hexTall','arrowL','lightning','wideRect','tallRect'],
  ],
  xhard:[
    ['roundsq','hexagon','arrowR','lightning'],
    ['hexTall','arrowL','lightning','wideRect'],
    ['arrowR','lightning','parallelR','tallRect'],
    ['lightning','wideRect','tallRect','shield'],
    ...
    ['star','moon','heart','cross','pentagon','roundsq','hexagon'],
    ['tinyMoon','heart','cross','pentagon','ovalSq','hexTall','arrowL'],
    ['heart','cross','pentagon','roundsq','hexagon','arrowR','lightning'],
    ['cross','pentagon','ovalSq','hexTall','arrowL'],
    ['pentagon','roundsq','hexagon','arrowR','lightning'],
    ['ovalSq','hexTall','arrowL','lightning','wideRect'],
    ['hexagon','arrowR','lightning','parallelR','tallRect','shield'],
    ['arrowL','lightning','wideRect','tallRect','shield'],
  ],
  deadly:[
    ['lightning','parallelR','tallRect','shield'],
    ['wideRect','tallRect','shield','trapezoid'],
    ...
    ['cross','pentagon','roundsq','hexagon','arrowR','lightning'],
    ['pentagon','ovalSq','hexTall','arrowL','lightning','wideRect'],
    ['roundsq','hexagon','arrowR','lightning','parallelR'],
    ['hexTall','arrowL','lightning','wideRect','tallRect','shield'],
    ['arrowR','lightning','parallelR','tallRect','shield','trapezoid','triangle'],
    ['lightning','wideRect','tallRect','shield','trapezoid','triR','ovalH'],
