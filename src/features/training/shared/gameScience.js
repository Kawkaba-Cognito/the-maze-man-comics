...
export const GAME_SCIENCE = {
  ...
  'synonyms': {
    en: {
      title: 'The science',
      intro: 'Choosing a synonym or opposite taps semantic memory — your deep store of word meanings.',
      sections: [
        { h: '📚 Semantic memory', b: 'Matching meaning strengthens the web of word knowledge that makes up crystallized intelligence — what you’ve learned over a lifetime.' },
        { h: '🔁 Relational meaning', b: 'Same-vs-opposite judgments train how you represent relations between concepts, not just words in isolation.' },
        { h: '🗣 Verbal ability', b: 'Vocabulary depth is one of the strongest predictors of reading comprehension and clear communication.' },
      ],
      foot: 'Read all options first — the best fit, not just a close one, wins.',
    },
    ar: {
      title: 'العلم وراء اللعبة',
      intro: 'اختيار المرادف أو الضدّ يستثمر الذاكرة الدلالية — مخزونك العميق لمعاني الكلمات.',
      sections: [
        { h: '📚 الذاكرة الدلالية', b: 'مطابقة المعنى تقوّي شبكة معرفة الكلمات التي تُكوّن الذكاء المتبلور — ما تعلّمته عبر العمر.' },
        { h: '🔁 المعنى العلائقي', b: 'أحكام التماثل والتضادّ تدرّب تمثيلك للعلاقات بين المفاهيم، لا الكلمات منفردة فقط.' },
        { h: '🗣 القدرة اللفظية', b: 'عمق المفردات من أقوى المؤشّرات على فهم القراءة ووضوح التواصل.' },
      ],
      foot: 'اقرأ كل الخيارات أولاً — الأنسب يفوز لا القريب فحسب.',
    },
  },
  'odd-one-out': {
    en: {
      title: 'The science',
      intro: 'Spotting the word that doesn’t belong trains categorization and abstraction.',
      sections: [
        { h: '🗂 Categorization', b: 'Finding the misfit means extracting the category the others share — the brain’s way of organising the world into concepts.' },
        { h: '🧠 Abstraction & inhibition', b: 'You must look past surface similarity to the deeper rule, and inhibit the tempting-but-wrong answer.' },
        { h: '📚 Verbal reasoning', b: 'Working with shifting categories builds semantic flexibility — moving nimbly between meanings.' },
      ],
      foot: 'Ask what three of them have in common, then the fourth stands out.',
    },
    ar: {
      title: 'العلم وراء اللعبة',
      intro: 'اكتشاف الكلمة التي لا تنتمي يدرّب التصنيف والتجريد.',
      sections: [
        { h: '🗂 التصنيف', b: 'إيجاد الشاذّ يعني استخلاص الفئة التي تشترك بها البقية — طريقة الدماغ في تنظيم العالم إلى مفاهيم.' },
        { h: '🧠 التجريد والكبح', b: 'عليك تجاوز التشابه السطحي إلى القاعدة الأعمق، وكبح الإجابة المغرية الخاطئة.' },
        { h: '📚 الاستدلال اللفظي', b: 'العمل مع فئات متغيّرة يبني المرونة الدلالية — التنقّل الرشيق بين المعاني.' },
      ],
      foot: 'اسأل ما الذي تشترك به ثلاث منها، فتبرز الرابعة.',
    },
  },
};
