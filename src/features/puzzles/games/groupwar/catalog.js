...
export const WAR_GAMES = [
  ...
  },
  {
    ...
    icon: '🔀',
    accent: '#7b2cbf',
    blurb: { en: 'Answer the colour, then the shape — only the rule moves.', ar: 'أجب عن اللون ثم الشكل — القاعدة وحدها تتغيّر.' },
    loader: () => import('../../../training/domains/flexibility/games/task-switch').then((m) => m.TaskSwitchEngine),
    trials: { easy: 12, med: 18, hard: 24 },
    hardMode: 'passplay',
  },
];
