...
export const INK = '#2d2210'; export const SUB = '#524b3f'; export const FAINT = '#5a5144';
...
export default function PracticeShell({ title, accent, isAr, onBack, children }) {
  ...
  return (
    <div ref={rootRef} className="rxp-root" dir={isAr ? 'rtl' : 'ltr'}>
...
.rxp-title { font-family:${SERIF}; font-size:26px; font-weight:600; color:var(--universe-accent,#1f4f85); }
...
.rxp-primary { width:100%; max-width:340px; padding:15px; border-radius:14px; border:none; background:var(--acc); color:#201d18; font-size:16px; font-weight:800; cursor:pointer; font-family:inherit; box-shadow:3px 3px 0 rgba(26,18,8,0.14); }
