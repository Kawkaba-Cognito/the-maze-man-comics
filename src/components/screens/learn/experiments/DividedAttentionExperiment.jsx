          ...
          <>
            <div style={{ display: 'flex', gap: 24, marginBottom: 4 }}>
              <div>
                ...
                <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 24, color: chrome.text }}>{error1.toFixed(1)}</div>
              </div>
              <div>
                <div style={{ fontSize: 11, color: chrome.muted, fontWeight: 700 }}>{t.divided}</div>
                <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 24, color: chrome.text }}>{error2.toFixed(1)}</div>
              </div>
            </div>
