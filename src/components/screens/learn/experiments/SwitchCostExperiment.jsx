          ...
          <>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20, marginBottom: 4 }}>
              <div>
                ...
                <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 24, color: chrome.text }}>{Math.round(singleRT)}ms</div>
              ...
              <div>
                ...
                <div style={{ fontFamily: "'Outfit',sans-serif", fontSize: 24, color: chrome.text }}>{Math.round(switchRT)}ms</div>
